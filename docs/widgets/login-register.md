...
eael_section_bit_integrations_promo → visible when the Bit Integrations plugin is NOT active (checked via `is_plugin_active('bit-integrations/bitwpfi.php')`) — independent of Pro status
```
