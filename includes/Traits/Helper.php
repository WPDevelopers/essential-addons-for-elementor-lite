        ...
        <script id="eael-gb-eb-banner-promo-template" type="text/html">
            <div id="eael-gb-eb-banner-promo">
                ...
                <div class="eael-gb-eb-banner-promo-right">
                    ...
                    <button class="eael-gb-eb-banner-promo-get-block eael-gb-eb-install" data-promotype="eb-banner" data-action="<?php echo esc_attr( $action ); ?>" data-nonce="<?php echo esc_attr( $nonce ); ?>"><?php _e( 'Get Essential Blocks', 'essential-addons-for-elementor-lite' ) ?></b>
