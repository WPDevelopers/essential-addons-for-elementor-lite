...
trait Admin {
	    ...
	    if ( isset( $hook ) && $hook == 'toplevel_page_eael-settings' ) {
		    ...
		    $ea_dashboard = [
			    ...
			    'admin_screen_promo'      => [
				    ...
				    'content' => sprintf( __( "<p> <i>📣</i> <b>NEW:</b> Introducing EA Pro 6.2 with New \"<b><a target='_blank' href='%s'>360 Degree Photo Viewer</a></b>\" and \"<b><a target='_blank' href='%s'>Multicolumn Pricing Table</a></b>\" widget! Check out the <a target='_blank' href='%s'>Changelog</a> 🎉</p>", "essential-addons-for-elementor-lite" ), esc_url( 'https://essential-addons.com/360-degree-photo-viewer' ), esc_url( 'https://essential-addons.com/multicolumn-pricing-table' ), esc_url( 'https://essential-addons.com/view-ea-changelog' ) )
			    ],
			    'pro_modal'               => [
    ...
    public function admin_notice() {
		...
		<div class="eael-black-friday-optin">
			<div>
				<p><?php _e( '🎁 <strong>SAVE 25% now</strong> & unlock 100+ advanced elements & 2800+ ready templates to design Elementor websites faster in 2025.', 'essential-addons-for-elementor-lite' ); ?></p>
			</div>
			<div>
