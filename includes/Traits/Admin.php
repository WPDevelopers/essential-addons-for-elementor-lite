...
trait Admin {
    ...
    public function admin_notice() {
		...
		<div class="eael-black-friday-optin">
			...
			echo __( '🛍️ This <strong>Black Friday</strong> enjoy up to 30% OFF on PRO plans. Get the best Essential Addons deal of the season now.', 'essential-addons-for-elementor-lite' ); 
			?></p>
			...
			<div>
				<p><?php
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo __( '🎁 <strong>SAVE 25% now</strong> & unlock 100+ advanced elements & 2800+ ready templates to design Elementor websites faster in 2025.', 'essential-addons-for-elementor-lite' ); ?></p>
			</div>
			<div>
