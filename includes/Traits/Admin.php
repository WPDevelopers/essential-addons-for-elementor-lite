...
trait Admin {
    ...
    public function admin_notice() {
		...
		<div class="eael-black-friday-optin">
			<p><?php _e( '🎁 Kickstart 2025 with Flat 25% OFF on every <strong>Essential Addons PRO plans</strong>. Get the best deal of the season now.', 'essential-addons-for-elementor-lite' ); ?></p>
