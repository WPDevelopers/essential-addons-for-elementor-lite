...
trait Admin {
    ...
    public function admin_enqueue_scripts( $hook ) {
        ...
        if ( isset( $hook ) && $hook == 'toplevel_page_eael-settings' ) {
	        ...
	        wp_enqueue_script( 'essential_addons_elementor-admin-dashboard-js', EAEL_PLUGIN_URL . 'includes/templates/admin/eael-dashboard/dist/assets/~/ea/wp-content/plugins/essential-addons-for-elementor-lite/includes/templates/admin/eael-dashboard/dist/assets/index-CqEwux4V.js', array( 'essential_addons_elementor-admin-js' ), EAEL_PLUGIN_VERSION, true );
