...
trait Woo_Product_Comparable {
	...
	public static function print_compare_button( $id, $btn_type = 'text' ) {
		...
		printf( '<button class="eael-wc-compare button" data-product-id="%d" rel="nofollow" title="Compare">%s</button>', intval( $id, 10 ), $btn_content );
	}
