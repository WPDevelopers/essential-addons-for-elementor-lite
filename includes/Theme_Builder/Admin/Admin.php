	...
	public static function get_script_data( $extra = [] ) {
		...
		$data = [
			...
			'i18n'          => [
				...
				'conditionTypeLabel' => __( 'Include or exclude', 'essential-addons-for-elementor-lite' ),
				...
				/* translators: %s: what the row targets, e.g. "All archives". */
				'conditionsHidden' => __( 'Hidden on %s', 'essential-addons-for-elementor-lite' ),
				'notNow'           => __( 'Not now', 'essential-addons-for-elementor-lite' ),
				...
				'saveOnly'         => __( 'Save & Close', 'essential-addons-for-elementor-lite' ),
				...
				'conditionsMenu'   => __( 'Display Conditions', 'essential-addons-for-elementor-lite' ),
				'conditionsSaved'  => __( 'Display conditions saved.', 'essential-addons-for-elementor-lite' ),
				'presetsButton'    => __( 'Essential Addons presets', 'essential-addons-for-elementor-lite' ),
				'presetsTitle'     => __( 'Choose a Header & Footer Preset', 'essential-addons-for-elementor-lite' ),
				'headerPresets'    => __( 'Header Presets', 'essential-addons-for-elementor-lite' ),
				'footerPresets'    => __( 'Footer Presets', 'essential-addons-for-elementor-lite' ),
				'clickToInsert'    => __( 'Click to Insert', 'essential-addons-for-elementor-lite' ),
				'loading'          => __( 'Loading', 'essential-addons-for-elementor-lite' ),
				'inserting'        => __( 'Inserting…', 'essential-addons-for-elementor-lite' ),
