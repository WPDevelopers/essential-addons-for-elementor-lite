...
class Content_Controls {
	...
	protected static function register_preset_section( Widget_Base $widget ) {
		...
		$widget->add_control( 'eael_mega_menu_preset', [
			...
			'description'  => esc_html__( 'A preset includes the logo, menu, and buttons. Selecting a preset replaces the current header. Use Undo to restore the previous design.', 'essential-addons-for-elementor-lite' ),
			'render_type'  => 'none',
		] );
