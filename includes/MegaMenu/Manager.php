	...
	public function enqueue_editor_scripts() {
		...
		wp_localize_script( 'eael-mega-menu-editor', 'eaelMegaMenuEditor', [
			...
			'i18n'      => [
				...
				'confirmHeader' => __( 'Applying this preset will replace the existing header content, including the logo, menu, panels, buttons, and any other elements within the header. Would you like to continue?', 'essential-addons-for-elementor-lite' ),
