    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .eael-contact-form-7 .wpcf7-form-control.wpcf7-text, {{WRAPPER}} .eael-contact-form-7 .wpcf7-form-control.wpcf7-date, {{WRAPPER}} .eael-contact-form-7 .wpcf7-form-control.wpcf7-textarea, {{WRAPPER}} .eael-contact-form-7 .wpcf7-form-control.wpcf7-select' => 'color: {{VALUE}}',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'eaelcf_after_submit_feedback_typography',
                'label' => __('Typography', 'essential-addons-for-elementor-lite'),
                'scheme' => Scheme_Typography::TYPOGRAPHY_4,
                'selector' => '{{WRAPPER}} .eael-contact-form-7 .wpcf7-mail-sent-ng',
                'separator' => 'before',
            ]
        );

        $this->add_control(
            'eaelcf_after_submit_feedback_color',
            [
                'label' => __('Text Color', 'essential-addons-for-elementor-lite'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_group_control(
            Group_Control_Background::get_type(),
            [
                'name' => 'eaelcf_after_submit_feedback_background',
                'label' => __('Background', 'essential-addons-for-elementor-lite'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .eael-contact-form-7 .wpcf7-mail-sent-ng',
                'separator' => 'before',
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'eaelcf_after_submit_feedback_border',
                'label' => __('Border', 'essential-addons-for-elementor-lite'),
                'placeholder' => '1px',
                'default' => '1px',
                'selector' => '{{WRAPPER}} .eael-contact-form-7 .wpcf7-mail-sent-ng',
        ...
        $this->add_responsive_control(
            'eaelcf_after_submit_feedback_border_radius',
            [
        ...
        $this->add_responsive_control(
            'eaelcf_after_submit_feedback_border_margin',
            [
        ...
        $this->add_responsive_control(
            'eaelcf_after_submit_feedback_border_padding',
            [
