    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#999',
                'selectors' => [
                    '{{WRAPPER}} .eael-pricing-item .eael-pricing-tag .price-tag .original-price' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#00C853',
                'selectors' => [
                    '{{WRAPPER}} .eael-pricing-item .eael-pricing-tag .price-tag .sale-price' => 'color: {{VALUE}};',
                ],
            ]
        );
