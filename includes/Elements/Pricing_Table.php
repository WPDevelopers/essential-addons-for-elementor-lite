...
class Pricing_Table extends Widget_Base
{
    ...
    protected function _register_controls()
    {
		...
		$this->add_control(
			'eael_pricing_table_ribbon_is_left_alignment',
			[
				'label' => __( 'Ribbon Alignment', 'essential-addons-for-elementor-lite' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Left', 'essential-addons-for-elementor-lite' ),
				'label_off' => __( 'Right', 'essential-addons-for-elementor-lite' ),
				'return_value' => 'yes',
				'condition' => [
    ...
    protected function render()
    {
		...
		$featured_class .= ($settings['eael_pricing_table_ribbon_is_left_alignment'] === 'yes' ? ' ribbon-left' : '');
