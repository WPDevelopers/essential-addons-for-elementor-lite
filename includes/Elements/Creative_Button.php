...
use HelperTrait;
    ...
    protected function register_controls()
    {
        ...
        $creative_button_effect_description = '10 more effects on <a href="https://wpdeveloper.com/in/upgrade-essential-addons-elementor">Pro version</a>';
        if ( apply_filters( 'eael/pro_enabled', false ) ) {
            $button_efects['eael-creative-button--pipaluk'] = esc_html__('Pipaluk', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--moema']   = esc_html__('Moema', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--wave']    = esc_html__('Wave', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--aylen']   = esc_html__('Aylen', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--saqui']   = esc_html__('Saqui', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--wapasha'] = esc_html__('Wapasha', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--nuka']    = esc_html__('Nuka', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--antiman'] = esc_html__('Antiman', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--quidel']  = esc_html__('Quidel', 'essential-addons-for-elementor-lite');
            $button_efects['eael-creative-button--shikoba'] = esc_html__('Shikoba', 'essential-addons-for-elementor-lite');

            $creative_button_effect_description = '';
        }
        ...
        $this->add_control(
            ...
            [
                ...
                'options'     => $button_efects,
                'description' => $creative_button_effect_description,
            ]
        );
        ...
        $this->add_control(
            'eael_creative_button_icon_color',
            [
        ...
        $eael_creative_button_background_color_selectors = [
        ...
        $eael_creative_button_gradient_background_selector = '
        ...
        $this->add_control(
            'eael_creative_button_hover_icon_color',
            [
                'label' => esc_html__('Icon Color', 'essential-addons-for-elementor-lite'),
                'type' => Controls_Manager::COLOR,
                'default' => '#ffffff',
        ...
        $eael_creative_button_hover_background_color_selectors = [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'default'   => '#f54',
                'selectors' => apply_filters( 'eael_creative_button/hover/background_color/selectors', $eael_creative_button_hover_background_color_selectors),
                'condition' => [
                    'use_gradient_background' => '',
                ],
            ]
        ...
        $eael_creative_button_hover_gradient_background_selector = '
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'     => ['gradient', 'classic'],
                'selector'  => apply_filters( 'eael_creative_button/hover/gradient_background/selector', $eael_creative_button_hover_gradient_background_selector ),
                'condition' => [
                    'use_gradient_background' => 'yes',
                ],
            ]
