...
class Formstack extends Widget_Base
{
    ...
    private function no_app_setup()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => __('Please set your app client credentials on the <strong>Formstack</strong> settings page.', 'essential-addons-for-elementor-lite'),
    ...
    private function no_forms_created()
    {
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __('Please create form on the <strong>Formstack</strong> settings page.', 'essential-addons-for-elementor-lite'),
                'content_classes' => 'eael-warning',
            ]
        );
    ...
    private function formstack_not_activated()
    {
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __('<strong>Formstack Online Forms</strong> is not installed/activated on your site. Please install and activate <a href="plugin-install.php?s=formstack&tab=search&type=term" target="_blank">Formstack Online Forms</a> first.', 'essential-addons-for-elementor-lite'),
                'content_classes' => 'eael-warning',
            ]
        );
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'description' => __('To sync latest created forms make sure you have <a href="' . add_query_arg(['clear_formstack_cache' => 'true'], admin_url('admin.php?page=Formstack')) . '">Refresh Formstack form cache</a>', 'essential-addons-for-elementor-lite'),
            ]
        );
    ...
    protected function render()
    {
		...
		$script_url   = add_query_arg( $extras, "https://www.formstack.com/forms/js.php?{$settings['form_key']}" );
        $noscript_url = add_query_arg( $extras, "https://www.formstack.com/forms/?{$settings['form_key']}" );
        ...
        <div class="fs_wp_sidebar">
            ...
            <noscript>
                <a href="<?php echo esc_url( $noscript_url ); ?>" title="<?php esc_attr_e( 'Online Form', 'essential-addons-for-elementor-lite' ); ?>">
                    <?php esc_html_e( 'Online Form', 'essential-addons-for-elementor-lite' ); ?>
                </a>
            </noscript>
