...
class Woo_Product_List extends Widget_Base {
	...
	protected $woo_product_list_settings = array();
	...
	protected function eael_get_product_orderby_options() {
		return apply_filters(
			'eael/woo-product-list/orderby-options',
			array(
	...
	protected function eael_get_product_filterby_options() {
		return apply_filters(
			'eael/woo-product-list/filterby-options',
			array(
	...
	protected function eael_product_list_layout() {
		...
		$this->add_control(
			'eael_woo_product_list_badge_show',
			array(
		...
		$this->add_control(
			'eael_woo_product_list_review_count_show',
			array(
		...
		$this->add_control(
			'eael_woo_product_list_category_show',
			array(
		...
		$this->add_control(
			'eael_woo_product_list_excerpt_show',
			array(
		...
		$this->add_control(
			'eael_woo_product_list_total_sold_show',
			array(
		...
		$this->add_control(
			'eael_woo_product_list_add_to_cart_button_show',
			array(
		...
		$this->add_control(
			'eael_woo_product_list_quick_view_button_show',
			array(
		...
		$this->add_control(
			'eael_woo_product_list_link_button_show',
			array(
	...
	protected function eael_product_list_query() {
		$this->start_controls_section(
			'eael_section_woo_product_list_query',
			array(
		...
		$this->add_control(
			'eael_product_list_product_filter',
			array(
				...
				'condition' => array(
					'post_type!' => array( 'source_dynamic', 'source_archive' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => 'date',
				'condition' => array(
					'eael_product_list_product_filter!' => array( 'best-selling-products', 'top-products' ),
					'post_type!'                        => 'source_archive',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'toggle'    => false,
				'condition' => array(
					'eael_product_list_product_filter!' => array( 'best-selling-products' ),
				),
			)
		);

		$this->add_control(
			'eael_woo_product_list_products_count',
			array(
		...
		$this->add_control(
			...
			array(
				...
				'return_value' => 'yes',
				'default'      => 'yes',
				/* translators: %s: WooCommerce Out of Stock visibility settings URL */
				'description'  => sprintf( __( 'Uncheck the WooCommerce Settings <a href="%s" target="_blank">Out of stock visibility</a> option. This will not work otherwise', 'essential-addons-for-elementor-lite' ), esc_url_raw( $wc_settings_url ) ),
			)
		);
	...
	protected function eael_product_list_image() {
		$this->start_controls_section(
			'eael_section_woo_product_list_image',
			array(
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::CHOOSE,
				'options' => array(
					'image-alignment-left'  => array(
						'title' => __( 'Left', 'essential-addons-for-elementor-lite' ),
						'icon'  => 'eicon-text-align-left',
					),
					'image-alignment-right' => array(
	...
	protected function eael_product_list_content() {
		$this->start_controls_section(
			'eael_section_woo_product_list_content',
			array(
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::CHOOSE,
				'options'   => array(
					'badge-alignment-left'  => array(
						'title' => __( 'Left', 'essential-addons-for-elementor-lite' ),
						'icon'  => 'eicon-text-align-left',
					),
					'badge-alignment-right' => array(
						'title' => __( 'Right', 'essential-addons-for-elementor-lite' ),
						'icon'  => 'eicon-text-align-right',
					),
				),
	...
	protected function eael_product_list_load_more() {
		$this->start_controls_section(
			'eael_section_woo_product_list_load_more',
			array(
				'label'     => esc_html__( 'Load More', 'essential-addons-for-elementor-lite' ),
				'condition' => array(
					'show_load_more' => 'yes',
	...
	protected function eael_product_list_item_content_style() {
		...
		$this->add_control(
			'eael_product_list_content_header_general_custom_spacing',
			array(
		...
		$this->add_control(
			'eael_product_list_content_body_title_style_info',
			array(
				'type'            => Controls_Manager::RAW_HTML,
	...
	protected function eael_product_list_popup_style() {
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'essential-addons-for-elementor-lite' ),
				'selector' => '.eael-popup-details-render div.product form.cart div.quantity .qty, .eael-product-popup.woocommerce div.product form.cart div.quantity > a',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#000',
				'selectors' => array(
					'.eael-popup-details-render div.product form.cart div.quantity .qty, .eael-product-popup.woocommerce div.product form.cart div.quantity > a, .eael-product-popup.woocommerce div.product form.cart div.quantity > .button' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#fff',
				'selectors' => array(
					'.eael-popup-details-render div.product form.cart div.quantity .qty, .eael-product-popup.woocommerce div.product form.cart div.quantity > a, .eael-product-popup.woocommerce div.product form.cart div.quantity > .button' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->start_controls_tab( 'eael_product_popup_cart_button_style_tabs_normal', array( 'label' => esc_html__( 'Normal', 'essential-addons-for-elementor-lite' ) ) );
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#fff',
				'selectors' => array(
					'.eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt,
                    .eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt.disabled' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'.eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt,
                    .eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt.disabled' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'eael_dynamic_template_layout' => 'preset-1',
				),
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#BC5C5C',
				'selectors' => array(
					'.eael-popup-details-render .button, .eael-popup-details-render button.button.alt,
                    .eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt.disabled' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'eael_dynamic_template_layout' => 'preset-2',
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '.eael-popup-details-render .button, .eael-popup-details-render button.button.alt, 
                .eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt.disabled',
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'.eael-popup-details-render .button, .eael-popup-details-render button.button.alt,
                    .eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt.disabled' => 'border-radius: {{SIZE}}px;',
				),
			)
		);
		...
		$this->start_controls_tab( 'eael_product_popup_cart_button_hover_styles', array( 'label' => esc_html__( 'Hover', 'essential-addons-for-elementor-lite' ) ) );
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'.eael-popup-details-render .button:hover, .eael-popup-details-render button.button.alt:hover,
                    .eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt.disabled:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'.eael-popup-details-render .button:hover, .eael-popup-details-render button.button.alt:hover,
                    .eael-popup-details-render .elementor-element-{{ID}} .button, .eael-popup-details-render button.button.alt.disabled:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '',
				'selectors' => array(
					'.eael-popup-details-render .button:hover, .eael-popup-details-render button.button.alt:hover' => 'border-color: {{VALUE}};',
				),
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'.eael-popup-details-render .product_meta' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'.eael-popup-details-render .product_meta .sku, .eael-popup-details-render .product_meta a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'.eael-popup-details-render .product_meta a:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'.eael-popup-details-render button.eael-product-popup-close' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'.eael-popup-details-render button.eael-product-popup-close' => 'max-width: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; min-height: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'.eael-popup-details-render button.eael-product-popup-close' => 'color: {{VALUE}}!important;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'.eael-popup-details-render button.eael-product-popup-close' => 'background-color: {{VALUE}}!important;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'.eael-popup-details-render button.eael-product-popup-close' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '.eael-popup-details-render button.eael-product-popup-close',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'.eael-popup-details-render .eael-product-popup-details' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'separator'  => 'before',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Box Shadow', 'essential-addons-for-elementor-lite' ),
				'selector' => '.eael-product-popup .eael-product-popup-details',
			)
		);
	...
	protected function content_header_position_conditions( $extra_conditions = array() ) {
		$conditions_wrap = array();
		$conditions      =
		array(
			'relation' => 'or',
			'terms'    => array(
	...
	protected function eael_get_product_statuses() {
		return apply_filters(
			'eael/woo-woo-product-list/product-statuses',
			array(
	...
	public static function get_woo_product_list_loop_settings( $product, $settings, $woo_product_list ) {
		$woo_product_list_loop = array();
		$product_id            = $product->get_id();

		$woo_product_list_loop['quick_view_setting'] = array(
	...
	public function eael_prepare_product_query( $settings ) {
		$args = array(
			...
			'post_status'    => ClassesHelper::eael_validate_product_statuses( ! empty( $settings['eael_product_list_products_status'] ) ? $settings['eael_product_list_products_status'] : array( 'publish' ) ),
		...
		switch ( $settings['eael_product_list_product_filter'] ) {
			...
			case 'manual':
				$args['post__in'] = ! empty( $settings['eael_product_list_products_in'] ) ? $settings['eael_product_list_products_in'] : array( 0 );
				break;
	...
	protected function render() {
		...
		add_filter( 'woocommerce_product_add_to_cart_text', array( $this, 'add_to_cart_button_custom_text' ) );
		?>
		...
		<?php
		remove_filter( 'woocommerce_product_add_to_cart_text', array( $this, 'add_to_cart_button_custom_text' ) );
	}
}
