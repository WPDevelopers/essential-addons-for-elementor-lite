...
class Woo_Product_List extends Widget_Base
{
    ...
    protected function eael_product_list_layout() {
        ...
        $this->add_control(
            'eael_product_list_layout_image_heading',
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .eael-product-list-wrapper .eael-product-list-review-count' => 'font-size: {{SIZE}}px;',
    ...
    protected function render() {
		...
		$woo_product_list = self::get_woo_product_list_settings( $settings );
