...
// use Essential_Addons_Elementor\Template\Content\Woo_Product_List as Woo_Product_List_Trait;
...
class Woo_Product_List extends Widget_Base
{
    ...
    {
        // $this->start_controls_section('eael_section_woo_product_list_settings', [
        ...
        // $this->add_control('eael_woo_product_list_product_filter', [
        ...
        //     'default' => 0,
        //     'condition' => [
        //         'eael_woo_product_list_product_filter!' => 'manual'
        //     ]
        // ]);

        // $this->add_control(
        //     'eael_woo_product_list_products_status',
        //     [
        ...
        // $this->add_control('eael_woo_product_list_categories', [
        ...
        // $this->add_control('eael_woo_product_list_products_in', [
        ...
        // $this->add_control(
        //     'eael_woo_product_list_title_html_tag',
        //     [
        ...
        //         ],
        //         'condition'=> [
        //             'eael_woo_product_list_style_preset!' => 'eael-product-default'
        //         ]
        //     ]
        // );

        // $this->add_control('eael_woo_product_list_rating', [
        //     'label' => esc_html__('Show Product Rating?', 'essential-addons-for-elementor-lite'),
        //     'type' => Controls_Manager::SWITCHER,
        //     'return_value' => 'yes',
        //     'default' => 'yes',
        //     'condition' => [
        //         'eael_woo_product_list_style_preset!' => ['eael-product-preset-8'],
        //     ],

        // ]);

        // $this->add_control(
        //     'eael_woo_product_list_price',
        //     [
        ...
        // );
        // $this->add_control(
        //     'eael_woo_product_list_excerpt_length',
        //     [
        //         'label' => __('Excerpt Words', 'essential-addons-for-elementor-lite'),
        //         'type' => Controls_Manager::NUMBER,
        //         'default' => '10',
        //         'condition' => [
        //             'eael_woo_product_list_excerpt' => 'yes',
        //             'eael_woo_product_list_layout' => 'list',
        //         ],
        //     ]
        // );
        ...
        // $this->add_control(
        //     'eael_woo_product_list_excerpt_expanison_indicator',
        //     [
        ...
        //     [
        //         'name' => 'eael_woo_product_list_image_size',
        //         'exclude' => ['custom'],
        //         'default' => 'medium',
        //         'label_block' => true,
        //     ]
	    ...
	    // $this->add_control(
		//     'eael_woo_product_list_image_clickable',
		//     [
	    ...
	    // $this->add_control(
		//     'eael_woo_product_list_wishlist',
		//     [
		...
		// 		    'content_classes' => 'eael-warning',
		// 		    'condition'       => [
		// 			    'eael_woo_product_list_wishlist' => 'yes'
		// 		    ],
		// 	    ]
		//     );
	    // }
    ...
    // {
    //     $this->start_controls_section(
    //         'eael_woo_product_list_add_to_cart_section',
    //         [
    ...
    // {
    //     $this->start_controls_section('eael_woo_product_list_load_more_section', [
    //         'label' => esc_html__('Load More', 'essential-addons-for-elementor-lite'),
    //         'conditions' => [
    //             'relation' => 'or',
    //             'terms' => [
    //                 [
    //                     'name' => 'eael_woo_product_list_layout',
    //                     'operator' => 'in',
    //                     'value' => [
    //                         'masonry',
    //                     ],
    ...
    //     $this->add_responsive_control(
    //         'eael_woo_product_list_content_alignment',
    //         [
    ...
    //             'toggle' => true,
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list:not(.list) .woocommerce ul.products li.product' => 'text-align: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list:not(.list) .woocommerce ul.products li.product .star-rating' => 'margin-{{VALUE}}: 0;',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'and',
    //                 'terms' => [
    ...
    //                     ],
    //                     [
    //                         'name' => 'eael_woo_product_list_style_preset',
    //                         'operator' => 'in',
    //                         'value' => [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_background_color',
    //         [
    //             'label' => esc_html__('Content Background Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#fff',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product, {{WRAPPER}} .eael-woo-product-list .icons-wrap.block-box-style' => 'background-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product.eael-product-list-preset-4 .product-details-wrap' => 'background-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product.eael-product-list-preset-3, {{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product.eael-product-list-preset-4'
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_border_color',
    //         [
    //             'label' => esc_html__('Border Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#ada8a8',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .price-wrap, {{WRAPPER}} .eael-woo-product-list .title-wrap' => 'border-color: {{VALUE}};',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'and',
    //                 'terms' => [
    ...
    //     $this->add_responsive_control(
    //         'eael_woo_peoduct_list_padding',
    //         [
    //             'label' => __('Padding', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::DIMENSIONS,
    //             'size_units' => ['px', '%', 'em'],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'and',
    //                 'terms' => [
    ...
    //     $this->start_controls_tabs('eael_woo_product_list_tabs', [
    //         'conditions' => [
    //             'relation' => 'or',
    //             'terms' => [
    //                 [
    ...
    //     $this->start_controls_tab('eael_woo_product_list_tabs_normal', ['label' => esc_html__('Normal', 'essential-addons-for-elementor-lite')]);

    //     $this->add_group_control(
    //         Group_Control_Border::get_type(),
    //         [
    //             'name' => 'eael_woo_peoduct_list_border',
    //             'fields_options' => [
    //                 'border' => [
    //                     'default' => 'solid',
    //                 ],
    ...
    //                 ],
    //             ],
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product',
    //             'condition' => [
    //                 'eael_woo_product_list_style_preset' => [
    //                     'eael-product-default',
    //                     'eael-product-simple',
    ...
    //         [
    //             'name' => 'eael_woo_peoduct_list_shadow',
    ...
    //     $this->start_controls_tab('eael_woo_product_list_hover_styles', ['label' => esc_html__('Hover', 'essential-addons-for-elementor-lite')]);

    //     $this->add_control(
    //         'eael_woo_product_list_hover_border_color',
    //         [
    //             'label' => esc_html__('Border Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product:hover' => 'border-color: {{VALUE}};',
    //             ],
    //             'condition' => [
    //                 'eael_woo_peoduct_list_border_border!' => '',
    //             ],
    //         ]
    //     );
    //     $this->add_group_control(
    //         Group_Control_Box_Shadow::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_box_shadow_hover',
    //             'label' => __('Box Shadow', 'essential-addons-for-elementor-lite'),
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product:hover',
    //         ]
    //     );
    ...
    //     $this->add_control(
    //         'eael_woo_peoduct_list_border_radius',
    //         [
    //             'label' => esc_html__('Border Radius', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::DIMENSIONS,
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product woocommerce-loop-product__link img' => 'border-radius: {{TOP}}px {{RIGHT}}px 0 0;',
    //                 '{{WRAPPER}} .eael-woo-product-list.list .woocommerce ul.products li.product .woocommerce-loop-product__link img' => 'border-radius: {{TOP}}px 0 0 {{LEFT}}px;',
    //             ],
    //         ]
    //     );

    //     $this->add_responsive_control(
    //         'eael_woo_product_list_image_width',
    //         [
    ...
    //             ],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list.list .eael-product-wrap .product-image-wrap' => 'width: {{SIZE}}%;',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_layout' => 'list',
    //             ],
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_details_heading',
    //         [
    ...
    //     $this->add_responsive_control(
    //         'eael_woo_product_list_details_alignment',
    //         [
    //             'label' => __('Alignment', 'essential-addons-for-elementor-lite'),
    ...
    //             'default' => 'center',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .product-details-wrap' => 'text-align: {{VALUE}};',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'and',
    //                 'terms' => [
    ...
    //     $this->add_responsive_control(
    //         'eael_woo_product_list_inner_padding',
    //         [
    //             'label' => __('Padding', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::DIMENSIONS,
    //             'size_units' => ['px', '%'],
    ...
    //             ],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list.grid .eael-product-wrap .product-details-wrap, {{WRAPPER}} .eael-woo-product-list.masonry .eael-product-wrap .product-details-wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'and',
    //                 'terms' => [
    ...
    //             ],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list.list .eael-product-list-preset-1 .eael-product-wrap .product-details-wrap, {{WRAPPER}} .eael-woo-product-list.list .eael-product-list-preset-4 .eael-product-wrap .product-details-wrap' => 'padding: {{SIZE}}px;',
    //                 '{{WRAPPER}} .eael-woo-product-list.list .eael-product-list-preset-2 .eael-product-wrap' => 'padding: {{SIZE}}px;',
    //                 '{{WRAPPER}} .eael-woo-product-list.list .eael-product-list-preset-2 .eael-product-wrap .product-details-wrap' => 'padding: 0 0 0 {{SIZE}}px;',
    //                 '{{WRAPPER}} .eael-woo-product-list.list .eael-product-list-preset-3 .eael-product-wrap .product-details-wrap' => 'padding: 0 0 0 {{SIZE}}px;',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_layout' => 'list',
    //             ],
    ...
    //             ],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list.list .eael-product-wrap .product-details-wrap' => 'width: {{SIZE}}%;',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_layout' => 'list',
    //             ],
    ...
    //     $this->start_controls_section(
    //         'eael_section_woo_product_list_typography',
    //         [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_product_title_heading',
    //         [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_product_title_color',
    //         [
    //             'label' => esc_html__('Product Title Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#272727',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .woocommerce-loop-product__title, {{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .eael-product-title h2' => 'color: {{VALUE}};',
    //             ],
    //         ]
    //     );
    ...
    //         [
    //             'name' => 'eael_woo_product_list_product_title_typography',
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .woocommerce-loop-product__title, {{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .eael-product-title h2',
    //         ]
    //     );

    //     $this->add_control(
    //         'eael_woo_product_list_product_price_heading',
    //         [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_product_price_color',
    //         [
    //             'label' => esc_html__('Price Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#272727',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .price, {{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .eael-product-price' => 'color: {{VALUE}};',
    //             ],
    //         ]
    //     );

    //     $this->add_control(
    //         'eael_woo_product_list_product_sale_price_color',
    //         [
    //             'label' => esc_html__('Sale Price Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .price ins, {{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .eael-product-price ins' => 'color: {{VALUE}};',
    //             ],
    //         ]
    //     );
    ...
    //         Group_Control_Typography::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_product_price_typography',
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .price,{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .eael-product-price',
    //         ]
    //     );

    //     $this->add_control(
    //         'eael_woo_product_list_product_rating_heading',
    //         [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_product_rating_color',
    //         [
    //             'label' => esc_html__('Rating Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#f2b01e',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce .star-rating::before' => 'color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce .star-rating span::before' => 'color: {{VALUE}};',
    //             ],
    //         ]
    //     );
    ...
    //         Group_Control_Typography::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_product_rating_typography',
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .star-rating',
    //             'conditions' => [
    //                 'relation' => 'or',
    //                 'terms' => [
    //                     [
    ...
    //     $this->add_responsive_control(
    //         'eael_woo_product_list_product_rating_size',
    //         [
    ...
    //             ],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .star-rating' => 'font-size: {{SIZE}}px!important;',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'or',
    //                 'terms' => [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_product_desc_heading',
    //         [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_product_desc_color',
    //         [
    //             'label' => esc_html__('Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#272727',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .eael-product-excerpt' => 'color: {{VALUE}};',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_layout' => 'list',
    //                 'eael_woo_product_list_excerpt' => 'yes',
    ...
    //         Group_Control_Typography::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_product_desc_typography',
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce ul.products li.product .eael-product-excerpt',
    //             'condition' => [
    //                 'eael_woo_product_list_layout' => 'list',
    //                 'eael_woo_product_list_excerpt' => 'yes',
    //             ],
	...
	//     $this->start_controls_section(
	// 	    'eael_section_woo_product_list_sale_badge_style',
	// 	    [
	...
	//     $this->add_control(
	// 	    'eael_woo_product_list_sale_badge_color',
	// 	    [
	...
	//     $this->add_control(
	// 	    'eael_woo_product_list_sale_badge_background',
	// 	    [
	...
	// 	    Group_Control_Typography::get_type(),
	// 	    [
	// 		    'name' => 'eael_woo_product_list_sale_badge_typography',
	...
	//     // stock out badge
	//     $this->add_control(
	// 	    'eael_woo_product_list_stock_out_badge_heading',
	// 	    [
	...
	//     $this->add_control(
	// 	    'eael_woo_product_list_stock_out_badge_color',
	// 	    [
	...
	//     $this->add_control(
	// 	    'eael_woo_product_list_stock_out_badge_background',
	// 	    [
	...
	// 	    Group_Control_Typography::get_type(),
	// 	    [
	// 		    'name' => 'eael_woo_product_list_stock_out_badge_typography',
    ...
    //     // add to cart button
    //     $this->start_controls_section(
    //         'eael_section_woo_product_list_add_to_cart_styles',
    //         [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_add_to_cart_padding',
    //         [
    //             'label' => __('Padding', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::DIMENSIONS,
    //             'size_units' => ['px', '%', 'em'],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button,
    //                 {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button,
    //                 {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link,
    //                 {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist,
    //                 {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
    //             ],
    //         ]
    //     );

    //     $this->add_control(
    //         'eael_woo_product_list_add_to_cart_radius',
    //         [
    ...
    //                 {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link,
    //                 {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist,
    //                 {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
    //             ],
    //         ]
    //     );
    //     $this->add_control(
    //         'eael_woo_product_list_add_to_cart_is_gradient_bg',
    //         [
    ...
    //     $this->start_controls_tabs('eael_woo_product_list_add_to_cart_style_tabs');

    //     $this->start_controls_tab('normal', ['label' => esc_html__('Normal', 'essential-addons-for-elementor-lite')]);

    //     $this->add_control(
    //         'eael_woo_product_list_add_to_cart_color',
    //         [
    ...
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button, 
    //                 {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button' => 'color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link' => 'color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart' => 'color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist' => 'color: {{VALUE}};',
    //             ],
    //         ]
    //     );
    ...
    //         [
    //             'name' => 'eael_woo_product_list_add_to_cart_gradient_background',
    //             'label' => __('Background', 'essential-addons-for-elementor-lite'),
    //             'types' => ['classic', 'gradient'],
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button,
    //             {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button,
    //             {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link,
    //             {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist,
    //             {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart',
    //             'condition' => [
    //                 'eael_woo_product_list_add_to_cart_is_gradient_bg' => 'yes'
    //             ]
    //         ]
    //     );

    //     $this->add_control(
    //         'eael_woo_product_list_add_to_cart_background',
    //         [
    ...
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button, 
    //                 {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button' => 'background-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link' => 'background-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart' => 'background-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist' => 'background-color: {{VALUE}};',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_add_to_cart_is_gradient_bg' => ''
    //             ]
    ...
    //         Group_Control_Border::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_add_to_cart_border',
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button, 
    //             {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button, 
    //             {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link, 
    //             {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist, 
    ...
    //         Group_Control_Typography::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_add_to_cart_typography',
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button,
    //             {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button',
    //             'condition' => [
    //                 'eael_woo_product_list_style_preset' => ['eael-product-default', 'eael-product-simple'],
    //             ],
    //         ]
    //     );
    ...
    //     $this->start_controls_tab('eael_woo_product_list_add_to_cart_hover_styles', ['label' => esc_html__('Hover', 'essential-addons-for-elementor-lite')]);

    //     $this->add_control(
    //         'eael_woo_product_list_add_to_cart_hover_color',
    //         [
    //             'label' => esc_html__('Button Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#fff',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button:hover,
    //                 {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button:hover' => 'color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link:hover' => 'color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart:hover' => 'color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist:hover' => 'color: {{VALUE}};',
    //             ],
    //         ]
    //     );
    //     $this->add_group_control(
    //         \Elementor\Group_Control_Background::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_add_to_cart_hover_gradient_background',
    //             'label' => __('Background', 'essential-addons-for-elementor-lite'),
    //             'types' => ['classic', 'gradient'],
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button:hover,
    //             {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button:hover,
    //             {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link:hover,
    //             {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist:hover,
    //             {{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart:hover',
    //             'condition' => [
    //                 'eael_woo_product_list_add_to_cart_is_gradient_bg' => 'yes'
    //             ]
    //         ]
    //     );
    //     $this->add_control(
    //         'eael_woo_product_list_add_to_cart_hover_background',
    //         [
    //             'label' => esc_html__('Background', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#333',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button:hover,
    //                 {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button:hover' => 'background-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link:hover' => 'background-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart:hover' => 'background-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist:hover' => 'background-color: {{VALUE}};',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_add_to_cart_is_gradient_bg' => '',
    //             ],
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_add_to_cart_hover_border_color',
    //         [
    //             'label' => esc_html__('Border Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button:hover,
    //                 {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button:hover' => 'border-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .product-link:hover' => 'border-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart:hover' => 'border-color: {{VALUE}};',
    //                 '{{WRAPPER}} .eael-woo-product-list.eael-product-overlay .woocommerce ul.products li.product .overlay .add_to_wishlist:hover' => 'border-color: {{VALUE}};',
    //             ],
    //         ]
    //     );
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_quick_view',
    //         [
    ...
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_quick_view' => 'yes',
    //             ],
    //         ]
    //     );
    ...
    // {
    //     $this->start_controls_section(
    //         'eael_section_woo_product_list_buttons_styles',
    //         [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_buttons_preset5_background',
    //         [
    //             'label' => esc_html__('Background Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#8040FF',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap.block-style' => 'background: {{VALUE}};',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'and',
    //                 'terms' => [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_buttons_icon_size',
    //         [
    ...
    //             ],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list.list .eael-product-wrap .icons-wrap li a i' => 'font-size: {{SIZE}}px;',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_layout' => 'list',
    //             ],
    ...
    //         Group_Control_Typography::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_buttons_typography',
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .icons-wrap li.add-to-cart a',
    //         ]
    //     );

    //     $this->add_control(
    //         'eael_woo_product_list_buttons_preset5_border_color',
    //         [
    //             'label' => esc_html__('Border Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#fff',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .icons-wrap.block-style li' => 'border-color: {{VALUE}};',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'and',
    //                 'terms' => [
    ...
    //     $this->start_controls_tabs('eael_woo_product_list_buttons_style_tabs');

    //     $this->start_controls_tab('eael_woo_product_list_buttons_style_tabs_normal', ['label' => esc_html__('Normal', 'essential-addons-for-elementor-lite')]);

    //     $this->add_control(
    //         'eael_woo_product_list_buttons_color',
    //         [
    //             'label' => esc_html__('Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#fff',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap li a' => 'color: {{VALUE}};',
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_buttons_background',
    //         [
    //             'label' => esc_html__('Background Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#8040FF',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap li a' => 'background-color: {{VALUE}};',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'or',
    //                 'terms' => [
    ...
    //         Group_Control_Border::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_buttons_border',
    //             'selector' => '{{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button,
    //             {{WRAPPER}} .eael-woo-product-list .woocommerce li.product .button.add_to_cart_button, 
    //             {{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap li a',
    //             'conditions' => [
    //                 'relation' => 'or',
    //                 'terms' => [
    //                     [
    ...
    //     );
    //     $this->add_control(
    //         'eael_woo_product_list_buttons_border_radius',
    //         [
    //             'label' => esc_html__('Border Radius', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::SLIDER,
    //             'range' => [
    ...
    //             ],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap:not(.details-block-style-2) li a' => 'border-radius: {{SIZE}}px;',
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap.details-block-style-2 li:only-child a' => 'border-radius: {{SIZE}}px!important;',
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap.details-block-style-2 li:first-child a' => 'border-radius: {{SIZE}}px 0 0 {{SIZE}}px;',
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap.details-block-style-2 li:last-child a' => 'border-radius: 0 {{SIZE}}px {{SIZE}}px 0;',
    //             ],
    //         ]
    //     );

    //     $this->add_control(
    //         'eael_woo_product_list_buttons_top_spacing',
    //         [
    ...
    //             ],
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap' => 'margin-top: {{SIZE}}px;',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_layout' => 'list',
    //             ],
    ...
    //     $this->start_controls_tab('eael_woo_product_list_buttons_hover_styles', ['label' => esc_html__('Hover', 'essential-addons-for-elementor-lite')]);

    //     $this->add_control(
    //         'eael_woo_product_list_buttons_hover_color',
    //         [
    //             'label' => esc_html__('Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#F5EAFF',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap li a:hover' => 'color: {{VALUE}};',
    //             ],
    //         ]
    //     );

    //     $this->add_control(
    //         'eael_woo_product_list_buttons_hover_background',
    //         [
    //             'label' => esc_html__('Background Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#333',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap li a:hover' => 'background-color: {{VALUE}};',
    //             ],
    //             'conditions' => [
    //                 'relation' => 'or',
    //                 'terms' => [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_buttons_hover_border_color',
    //         [
    //             'label' => esc_html__('Border Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '',
    //             'selectors' => [
    //                 '{{WRAPPER}} .eael-woo-product-list .eael-product-wrap .icons-wrap li a:hover' => 'border-color: {{VALUE}};',
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_buttons_border_border!' => '',
    //                 'eael_woo_product_list_style_preset!' => 'eael-product-preset-5',
    //             ],
    //         ]
    //     );
    ...
    //     $this->start_controls_section(
    //         'eael_woo_product_list_pagination_section',
    //         [
    //             'label' => __('Pagination', 'essential-addons-for-elementor-lite'),
    //             'tab' => Controls_Manager::TAB_CONTENT,
    //             'condition' => [
    //                 'eael_woo_product_list_layout' => ['grid', 'list'],
    //                 'show_load_more!' => 'true'
    //             ],
    //         ]
    //     );
    ...
    //     $this->add_responsive_control(
    //         'eael_woo_product_list_pagination_alignment',
    //         [
    //             'label' => __('Alignment', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::CHOOSE,
    //             'options' => [
    ...
    //     $this->add_responsive_control(
    //         'eael_woo_product_list_pagination_top_spacing',
    //         [
    //             'label' => esc_html__('Top Spacing', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::SLIDER,
    //             'range' => [
    ...
    //         Group_Control_Typography::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_pagination_typography',
    //             'selector' => '{{WRAPPER}} .eael-woo-pagination',
    //         ]
    //     );

    //     $this->start_controls_tabs('eael_woo_product_list_pagination_tabs');

    //     // Normal State Tab
    //     $this->start_controls_tab('eael_woo_product_list_pagination_normal', ['label' => esc_html__('Normal', 'essential-addons-for-elementor-lite')]);

    //     $this->add_control(
    //         'eael_woo_product_list_pagination_normal_text_color',
    //         [
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_pagination_normal_bg_color',
    //         [
    //             'label' => esc_html__('Background Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#fff',
    ...
    //         Group_Control_Border::get_type(),
    //         [
    //             'name' => 'eael_woo_product_list_pagination_normal_border',
    ...
    //     // Hover State Tab
    //     $this->start_controls_tab('eael_woo_product_list_pagination_hover', ['label' => esc_html__('Hover', 'essential-addons-for-elementor-lite')]);

    //     $this->add_control(
    //         'eael_woo_product_list_pagination_hover_text_color',
    //         [
    //             'label' => esc_html__('Text Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#fff',
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_pagination_hover_bg_color',
    //         [
    //             'label' => esc_html__('Background Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#8040FF',
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_pagination_hover_border_color',
    //         [
    //             'label' => esc_html__('Border Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '',
    ...
    //             ],
    //             'condition' => [
    //                 'eael_woo_product_list_pagination_normal_border_border!' => '',
    //             ]
    //         ]
    ...
    //     // Active State Tab
    //     $this->start_controls_tab('eael_woo_product_list_pagination_active', ['label' => esc_html__('Active', 'essential-addons-for-elementor-lite')]);

    //     $this->add_control(
    //         'eael_woo_product_list_pagination_hover_text_active',
    //         [
    //             'label' => esc_html__('Text Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#fff',
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_pagination_active_bg_color',
    //         [
    //             'label' => esc_html__('Background Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '#8040FF',
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_pagination_active_border_color',
    //         [
    //             'label' => esc_html__('Border Color', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::COLOR,
    //             'default' => '',
    ...
    //     $this->add_control(
    //         'eael_woo_product_list_pagination_border_radius',
    //         [
    //             'label' => esc_html__('Border Radius', 'essential-addons-for-elementor-lite'),
    //             'type' => Controls_Manager::SLIDER,
    //             'range' => [
...
//     }
	...
	// 	return $settings['eael_woo_product_list_image_size_size'];
	// }
    ...
    //     $args = [
    //         'post_type' => 'product',
    //         'post_status'    => ! empty( $settings['eael_woo_product_list_products_status'] ) ? $settings['eael_woo_product_list_products_status'] : [ 'publish', 'pending', 'future' ],
    //         'posts_per_page' => $settings['eael_woo_product_list_products_count'] ?: 4,
    ...
    //     if (!empty($settings['eael_woo_product_list_categories'])) {
    //         $args['tax_query'] = [
    //             [
    //                 'taxonomy' => 'product_cat',
    //                 'field' => 'slug',
    //                 'terms' => $settings['eael_woo_product_list_categories'],
    //                 'operator' => 'IN',
    //             ],
    //         ];
    //     }
    ...
    //     if ($settings['eael_woo_product_list_product_filter'] == 'featured-products') {
    //         $args['tax_query'] = [
    //             'relation' => 'AND',
    //             [
    //                 'taxonomy' => 'product_visibility',
    ...
    //         if ($settings['eael_woo_product_list_categories']) {
    //             $args['tax_query'][] = [
    //                 'taxonomy' => 'product_cat',
    //                 'field' => 'slug',
    //                 'terms' => $settings['eael_woo_product_list_categories'],
    ...
    //         }
    //     }
    //     else if ($settings['eael_woo_product_list_product_filter'] == 'best-selling-products') {
    //         $args['meta_key'] = 'total_sales';
    //         $args['orderby'] = 'meta_value_num';
    //         $args['order'] = 'DESC';
    //     }
    //     else if ($settings['eael_woo_product_list_product_filter'] == 'sale-products') {
    //         $args['post__in']  = array_merge( array( 0 ), wc_get_product_ids_on_sale() );
    //     }
    //     else if ($settings['eael_woo_product_list_product_filter'] == 'top-products') {
    //         $args['meta_key'] = '_wc_average_rating';
    //         $args['orderby'] = 'meta_value_num';
    //         $args['order'] = 'DESC';
    //     }
    //     else if( $settings['eael_woo_product_list_product_filter'] == 'manual' ){
    //         $args['post__in'] = $settings['eael_woo_product_list_products_in'] ? $settings['eael_woo_product_list_products_in'] : [ 0 ];
    //     }
