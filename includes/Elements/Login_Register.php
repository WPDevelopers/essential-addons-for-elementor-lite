...
class Login_Register extends Widget_Base {
	...
	protected function render() {
		...
		?>
        <div class="eael-login-registration-wrapper" data-is-ajax="<?php echo esc_attr($this->get_settings_for_display('enable_ajax')); ?>" data-is-recaptcha="<?php echo esc_attr($this->get_settings_for_display('enable_recaptcha')); ?>" data-recaptcha-sitekey="<?php echo esc_attr(get_option('eael_recaptcha_sitekey')); ?>" >
			<?php
