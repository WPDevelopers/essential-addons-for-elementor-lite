					...
					if ( $show_logout_link && is_user_logged_in() && ! $this->in_editor ) {
                        ...
                        <div class="lr-form-wrapper">
                            ...
                            <form class="eael-login-form eael-lr-form"
                                  ...
                                  method="post">
								<?php
								if ( ! empty( $this->ds['position_for_login_form'] ) && 'top' === $this->ds['position_for_login_form'] ) {
								...
								$position = ! empty( $this->ds['position_for_login_form'] ) ? $this->ds['position_for_login_form'] : '';
								if ( !$position || ( ! empty( $this->ds['position_for_login_form'] ) && 'bottom' === $this->ds['position_for_login_form'] ) ) {
									do_action( 'eael/login-register/render_social_login_for_login_form', $this );
								}
