...
//			    ],
	...
	protected function init_style_product_controls() {
		...
		$this->add_responsive_control(
			'eael_product_carousel_content_alignment',
			[
				'label'     => __( 'Alignment', 'essential-addons-for-elementor-lite' ),
				...
				'toggle'    => true,
				'selectors' => [
					'{{WRAPPER}} .eael-product-slider' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#fff',
				'selectors' => [
					'{{WRAPPER}} .eael-woo-product-carousel-container:not(.slider-preset-2) .eael-product-slider' => 'background-color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .eael-product-slider' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_tab( 'eael_product_carousel_tabs_normal', [ 'label' => esc_html__( 'Normal', 'essential-addons-for-elementor-lite' ) ] );
		...
		$this->start_controls_tab( 'eael_product_carousel_hover_styles', [ 'label' => esc_html__( 'Hover', 'essential-addons-for-elementor-lite' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .eael-woo-product-carousel-container:not(.slider-preset-2) .eael-product-slider'           => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
	...
	protected function init_style_color_typography_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#272727',
				'selectors' => [
					'{{WRAPPER}} .eael-product-slider .woocommerce-loop-product__title, {{WRAPPER}} .eael-product-slider .eael-product-title h2' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'eael_product_carousel_product_title_typography',
				'selector' => '{{WRAPPER}} .eael-product-slider .woocommerce-loop-product__title, {{WRAPPER}} .eael-product-slider .eael-product-title h2',
			]
		);
		...
		$this->add_control(
			'eael_product_carousel_product_price_color',
			[
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .eael-product-slider .price',
			]
		);

		$this->add_control(
			'eael_product_carousel_product_rating_heading',
			[
		...
		$this->add_control(
			'eael_product_carousel_product_rating_color',
			[
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => 'eael_product_carousel_product_rating_typography',
				'selector' => '{{WRAPPER}} .eael-product-slider .star-rating',

			]
		);

		$this->add_responsive_control(
			'eael_product_carousel_product_rating_size',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-product-slider .star-rating' => 'font-size: {{SIZE}}px!important;',
				],
		...
		$this->add_control(
			'eael_product_carousel_product_desc_heading',
			[
		...
		$this->add_control(
			'eael_product_carousel_product_desc_color',
			[
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'      => 'eael_product_carousel_product_desc_typography',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => 'eael_product_carousel_sale_badge_typography',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => 'eael_product_carousel_stock_out_badge_typography',
...
// add to cart button
	...
	protected function eael_woo_product_carousel_buttons_style() {
		...
		$this->add_control(
			'eael_product_carousel_buttons_preset5_background',
			[
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-product-slider .eael-product-wrap .icons-wrap li a i' => 'font-size: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => 'eael_product_carousel_buttons_typography',
				'selector' => '{{WRAPPER}} .eael-product-slider .icons-wrap li.add-to-cart a',
			]
		);

		$this->add_control(
			'eael_product_carousel_buttons_preset5_border_color',
			[
				'label'     => esc_html__( 'Border Color', 'essential-addons-for-elementor-lite' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#fff',
		...
		$this->start_controls_tab( 'eael_product_carousel_buttons_style_tabs_normal', [ 'label' => esc_html__( 'Normal', 'essential-addons-for-elementor-lite' ) ] );
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .eael-product-slider .button.add_to_cart_button, {{WRAPPER}} .eael-product-slider .eael-product-wrap .icons-wrap li a',
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab( 'eael_product_carousel_buttons_hover_styles', [ 'label' => esc_html__( 'Hover', 'essential-addons-for-elementor-lite' ) ] );
	...
	protected function eael_woo_product_carousel_terms_style() {
		$this->start_controls_section(
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => 'eael_product_carousel_terms_border',
				'selector' => '{{WRAPPER}} .eael-product-cats a',
			]
		);
		...
		$this->add_control(
			'eael_product_carousel_terms_hover_border_color',
			[
				'label'     => esc_html__( 'Border Color', 'essential-addons-for-elementor-lite' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .eael-product-cats a:hover' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'eael_product_carousel_terms_border_border!' => '',
				],
			]
		);
		...
		$this->add_control(
			'eael_product_carousel_terms_spacing',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-product-cats' => 'margin-right: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-product-cats' => 'padding: {{TOP}}{{SIZE}}px {{RIGHT}}{{SIZE}}px {{BOTTOM}}{{SIZE}}px {{LEFT}}{{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-product-cats' => 'margin: {{TOP}}{{SIZE}}px {{RIGHT}}{{SIZE}}px {{BOTTOM}}{{SIZE}}px {{LEFT}}{{SIZE}}px;',
				],
			]
		);
	...
	protected function render() {
		...
		} else if ( $settings['eael_product_carousel_product_filter'] == 'best-selling-products' ) {
			$args['meta_key'] = 'total_sales';
			$args['orderby']  = 'meta_value_num';
			$args['order']    = 'DESC';
		} else if ( $settings['eael_product_carousel_product_filter'] == 'sale-products' ) {
			$args['meta_query'][] = [
				'relation' => 'OR',
				[
					'key'     => '_sale_price',
		...
		} else if ( $settings['eael_product_carousel_product_filter'] == 'top-products' ) {
...
//            'data-nonce' => wp_create_nonce('eael_product_grid'),
		...
		if ( $settings['eael_dynamic_template_layout'] ) {
			$this->add_render_attribute( 'eael-woo-product-carousel-wrap', 'data-type', $settings['eael_dynamic_template_layout'] );
		}
		...
		if ( ! empty( $settings['items']['size'] ) ) {
			$this->add_render_attribute( 'eael-woo-product-carousel-wrap', 'data-items', $settings['items']['size'] );
		}
		...
		if ( ! empty( $settings['margin_tablet']['size'] ) ) {
			$this->add_render_attribute( 'eael-woo-product-carousel-wrap', 'data-margin-tablet', $settings['margin_tablet']['size'] );
		}
		if ( ! empty( $settings['margin_mobile']['size'] ) ) {
			$this->add_render_attribute( 'eael-woo-product-carousel-wrap', 'data-margin-mobile', $settings['margin_mobile']['size'] );
		}
		...
		if ( ! empty( $settings['slider_speed']['size'] ) ) {
			$this->add_render_attribute( 'eael-woo-product-carousel-wrap', 'data-speed', $settings['slider_speed']['size'] );
		}
