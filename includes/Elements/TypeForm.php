    ...
    private function no_token_set () {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'             => __('Whoops! It seems like you haven\'t connected your Typeform account. To do this, navigate to WordPress <b>Dashboard -> Essential Addons -> Elements -> Typeform</b> (<a target="_blank" href="'.esc_url(admin_url( 'admin.php?page=eael-settings')).'">Get Access</a>).',
