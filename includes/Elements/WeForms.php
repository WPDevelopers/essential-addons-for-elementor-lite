        ...
        if(!function_exists('WeForms')) {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => __('<strong>WeForms</strong> is not installed/activated on your site. Please install and activate <strong>WeForms</strong> first.', 'essential-addons-elementor'),
