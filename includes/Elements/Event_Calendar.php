    ...
    protected function _register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'essential-addons-for-elementor-lite'),
                'selector' => '{{WRAPPER}} .fc-day-grid-event .fc-time',
            ]
        );
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fc-day-grid-event .fc-time' => 'color: {{VALUE}}',
                ],
                'separator'    => 'after'
			]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'essential-addons-for-elementor-lite'),
                'selector' => '{{WRAPPER}} .fc-day-grid-event .fc-title',
            ]
        );
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fc-day-grid-event .fc-title' => 'color: {{VALUE}}',
                ],
                'separator'    => 'after'
			]
        );
