...
class Image_Masking {
    ...
    private function clip_paths( $shape ){
        $shapes = [
            ...
            'left-arrow'  => 'polygon(100% 40%, 40% 40%, 40% 20%, 0% 50%, 40% 80%, 40% 60%, 100% 60%)',
            ...
            'frame'       => 'polygon(10% 10%, 90% 10%, 90% 90%, 10% 90%, 10% 75%, 75% 75%, 75% 25%, 10% 25%)',
    ...
    private function get_clip_path_options() {
        return [
            ...
            'left-arrow'    => '⬅️ ' . esc_html__( 'left-arrow', 'essential-addons-for-elementor-lite' ),
	...
	public function before_render( $element ) {
		...
		if ( 'yes' === $is_enabled ) {
			...
			if( 'clip' === $type ){
                ...
                $style .= '.eael-image-masking-'.$element_id.' img {clip-path: '.$this->clip_paths( $clip_path ).'}';
			}
