...
class Skin_Three extends Skin_Base
{
    ...
    {
        return __('Skin Three', 'essential-addons-for-elementor-lite');
    }
    ...
    public function section_style_menu(Widget_Base $widget)
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .eael-simple-menu-container, {{WRAPPER}} .eael-simple-menu.eael-simple-menu-horizontal.eael-simple-menu-responsive, {{WRAPPER}} .eael-simple-menu-container .eael-simple-menu-toggle',
                'fields_options' => [
                    'border' => [
                        'default' => 'solid',
                    ],
    ...
    public function section_style_dropdown(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'skin_three_eael_simple_menu_layout' => ['horizontal'],
                ],
            ]
        );
    ...
    public function render()
    {
        ...
        $menu_classes = ['eael-simple-menu', $settings['skin_three_eael_simple_menu_dropdown_animation'], 'eael-simple-menu-indicator'];
        $container_classes = ['eael-simple-menu-container', $settings['skin_three_eael_simple_menu_item_alignment'], $settings['skin_three_eael_simple_menu_dropdown_item_alignment']];

        if ($settings['skin_three_eael_simple_menu_layout'] == 'horizontal') {
            $menu_classes[] = 'eael-simple-menu-horizontal';
        } else {
            $menu_classes[] = 'eael-simple-menu-vertical';
        }

        if (isset($settings['skin_three_eael_simple_menu_item_dropdown_indicator']) && $settings['skin_three_eael_simple_menu_item_dropdown_indicator'] == 'yes') {
        ...
        $this->parent->add_render_attribute('eael-simple-menu', [
            ...
            'data-indicator-class' => $settings['skin_three_eael_simple_menu_item_indicator'],
            'data-dropdown-indicator-class' => $settings['skin_three_eael_simple_menu_dropdown_item_indicator'],
        ]);
