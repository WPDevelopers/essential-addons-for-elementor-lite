...
class WPDeveloper_Setup_Wizard {
	...
	public function setup_wizard_scripts( $hook ) {
		if ( isset( $hook ) && $hook == 'admin_page_eael-setup-wizard' ) {
			...
			wp_enqueue_script( 'essential_addons_elementor-setup-wizard-react-js', EAEL_PLUGIN_URL . 'assets/admin/js/quick-setup/quick-setup.js', array( 'wp-element' ), EAEL_PLUGIN_VERSION, true );
	...
	public function templately_content(){
		...
		<div class="eael-onboard-content-wrapper eael-onboard-templately mb-4 min-h-538">
			<div class="eael-general-content-item templates flex justify-between items-center gap-5">
				<div class="templates-content">
					...
					<div class="eael-templately-details flex flex-col gap-4">
						<div class="eael-content-details flex gap-3 items-center">
							<span>
						...
						<div class="eael-content-details flex gap-4 items-center">
							<span>
	...
	public function integrations_content(){
		...
		<div class="eael-onboard-content-wrapper eael-onboard-integrations min-h-538 mb-4">
			<div class="eael-connect-others flex gap-4 justify-between items-start mb-10">
				...
				<div class="toggle-wrapper flex items-center gap-2 eael-d-none">
			...
			<div class="eael-integration-content-wrapper onboard-scroll-wrap">
				...
				<div class="eael-integration-item">
					<div class="eael-integration-header flex gap-2 items-center">
						<img src="<?php echo esc_url( $plugin[ 'logo' ] ); ?>" alt="logo" width="30" />
