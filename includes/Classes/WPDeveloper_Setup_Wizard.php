...
class WPDeveloper_Setup_Wizard {
	...
	public function setup_wizard_scripts( $hook ) {
		if ( isset( $hook ) && $hook == 'admin_page_eael-setup-wizard' ) {
			...
			// wp_enqueue_script( 'essential_addons_elementor-setup-wizard-react-js', EAEL_PLUGIN_URL . 'assets/admin/js/quick-setup.js', array( 'wp-element' ), EAEL_PLUGIN_VERSION, true );
