		...
		public function deactivate_reasons_form() {
			...
			$styles .= '<style type="text/css">';
				...
				$styles .= '
                    ...
                    .wpinsights-goodbye-form-wrapper-essential_adons_elementor .wpinsights-goodbye-form-body #wpinsights-goodbye-options ul > li {
                        margin-bottom: 16px;
