 ...
 */
	class Plugin_Usage_Tracker {
		...
		public function deactivation_reasons() {
			...
			$form['body'] = __( "Could you tell us why you're deactivating our plugin? Your insights will help us improve.", 'disable-comments' );
