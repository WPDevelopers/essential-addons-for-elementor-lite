eael.hooks.addAction("init", "ea", () => {
	const initMarquee = function ($scope, $) {
		...
		var $pause_on_hover =
			...
			$dragable =
				$wooProductCarousel.data("grab-cursor") !== undefined ? $wooProductCarousel.data("grab-cursor") : false;
		...
		var $pause_on_hover =
			...
			$margin_tablet =
				$wooProductCarousel.data("margin-tablet") !== undefined
					...
					: 10,
			$margin_mobile =
				$wooProductCarousel.data("margin-mobile") !== undefined ? $wooProductCarousel.data("margin-mobile") : 0,
			$autoplay =
				$wooProductCarousel.data("autoplay") !== undefined ? $wooProductCarousel.data("autoplay") : 999999,
			$pagination =
			...
			$items_tablet =
				$wooProductCarousel.data("items-tablet") !== undefined ? $wooProductCarousel.data("items-tablet") : 3,
			$items_mobile =
				$wooProductCarousel.data("items-mobile") !== undefined ? $wooProductCarousel.data("items-mobile") : 3,
			$slideItems =
				$wooProductCarousel.data("slide-items") !== undefined ? $wooProductCarousel.data("slide-items") : 1,
			...
			$grab_cursor =
				$wooProductCarousel.data("grab-cursor") !== undefined ? $wooProductCarousel.data("grab-cursor") : 0,
		...
		if ($effect === "slide") {
			if (typeof localize.el_breakpoints === "string") {
				...
				let el_breakpoints = {},
					breakpoints = {},
					bp_index = 0,
					desktopBreakPoint = localize.el_breakpoints.widescreen.is_enabled
						? localize.el_breakpoints.widescreen.value - 1
						: 4800;
				...
				$.each(
					["mobile", "mobile_extra", "tablet", "tablet_extra", "laptop", "desktop", "widescreen"],
					function (index, device) {
						...
						if (breakpoint.is_enabled) {
							...
							$itemsPerView =
								_items !== undefined && _items !== "" ? _items : device === "desktop" ? $items : 3;
							$slidePerGroup =
								_slideItems !== undefined && _slideItems !== ""
									? _slideItems
									: device === "desktop"
										? $slideItems
										: 1;
