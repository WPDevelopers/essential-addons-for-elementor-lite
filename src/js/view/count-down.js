var CountDown = function ($scope, $) {
	var $coundDown = $scope.find(".eael-countdown-wrapper").eq(0),
		...
		$expiry_text = $coundDown.data("expiry-text") !== undefined ? ea.sanitizeXSSHtml($coundDown.data("expiry-text")) : "",
		$expiry_title = $coundDown.data("expiry-title") !== undefined ? ea.sanitizeXSSHtml($coundDown.data("expiry-title")) : "",
