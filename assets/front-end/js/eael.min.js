...
jQuery,jQuery(document).ready(function(){isEditMode&&elementor.settings.editorPreferences.addChangeCallback("eael_feature_list_icon_position",function(e){console.log(e),console.log("changed")})});
