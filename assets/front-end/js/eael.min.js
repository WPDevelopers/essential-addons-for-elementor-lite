...
var Advanced_Data_Table=function(e,a){if(isEditMode){var t=e.context.querySelector(".ea-advanced-data-table");t.classList.add("ea-advanced-data-table-editable"),t.querySelectorAll("th, td").forEach(function(e){var a=e.innerHTML;0!==a.indexOf("<textarea>")&&(e.innerHTML="<textarea>"+a+"</textarea>")})}},Advanced_Data_Table_Inline_Edit=function(e,d,a){setTimeout(function(){if(a.el.querySelector(".ea-advanced-data-table")){var t,n=a.el.querySelector(".ea-advanced-data-table");n.querySelectorAll("textarea").forEach(function(e){e.addEventListener("focusout",function(e){clearTimeout(t);var a=n.cloneNode(!0);a.querySelectorAll("th, td").forEach(function(e){var a=e.querySelector("textarea").value;e.innerHTML=a}),d.remoteRender=!1,d.setSetting("ea_adv_data_table_static_html",a.innerHTML),t=setTimeout(function(){d.remoteRender=!0},1001)})})}},300)};jQuery(window).on("elementor/frontend/init",function(){isEditMode&&elementor.hooks.addAction("panel/open_editor/widget/eael-advanced-data-table",Advanced_Data_Table_Inline_Edit),elementorFrontend.hooks.addAction("frontend/element_ready/eael-advanced-data-table.default",Advanced_Data_Table)});
...
var dataTable=function(e,a){var t=e.find(".eael-data-table-wrap");t.data("table_id");if("undefined"!=typeof enableProSorter&&a.isFunction(enableProSorter)&&a(document).ready(function(){enableProSorter(jQuery,t)}),1==t.data("custom_responsive")){var n=e.find(".eael-data-table").find("th");e.find(".eael-data-table").find("tbody").find("tr").each(function(e,t){a(t).find("td .td-content-wrapper").each(function(e,t){a(this).prepend('<div class="th-mobile-screen">'+n.eq(e).html()+"</div>")})})}};jQuery(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/eael-data-table.default",dataTable),elementor.hooks.addFilter("elements/widget/contextMenuGroups",function(e,i){return"eael-data-table"==i.options.model.attributes.widgetType&&e.push({name:"ea_data_table",actions:[{name:"export_csv",title:"Export as CSV",callback:function(){for(var e=document.querySelector("#eael-data-table-"+i.options.model.attributes.id).querySelectorAll("table tr"),t=[],a=0;a<e.length;a++){for(var n=[],o=e[a].querySelectorAll("th, td"),d=0;d<o.length;d++)n.push(JSON.stringify(o[d].innerText.replace(/(\r\n|\n|\r)/gm," ").trim()));t.push(n.join(","))}var r=new Blob([t.join("\n")],{type:"text/csv"}),l=parent.document.createElement("a");l.classList.add("eael-data-table-download-"+i.options.model.attributes.id),l.download="eael-data-table-"+i.options.model.attributes.id+".csv",l.href=window.URL.createObjectURL(r),l.style.display="none",parent.document.body.appendChild(l),l.click(),parent.document.querySelector(".eael-data-table-download-"+i.options.model.attributes.id).remove()}}]}),e})});
