...
jQuery(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/eael-event-calendar.default",function(e,t){var a=e.find(".eael-event-calendar-cls"),n=a.data("events"),l=a.data("days_week"),d=a.data("month_names"),o=a.data("first_day"),r=document.getElementById("eaelecModal"),c=document.getElementsByClassName("eaelec-modal-close")[0];t("#eael-event-calendar").fullCalendar({editable:!1,draggable:!1,firstDay:o,slotLabelFormat:"HH:mm",nextDayThreshold:"00:00:00",header:{left:"prev,next today",center:"title",right:"month,agendaWeek,agendaDay"},events:n,selectable:!0,selectHelper:!0,dayNamesShort:l,monthNames:d,eventRender:function(e,a){a.attr("href","javascript:void(0);"),a.click(function(){r.style.display="block",t("span.eaelec-event-date-start").html('<i class="eicon-calendar"></i> '+moment(e.start).format("MMM Do, h:mm A")),t("span.eaelec-event-date-end").html('<i class="eicon-calendar"></i> '+moment(e.end).format("MMM Do, h:mm A")),t(".eaelec-modal-header h2").html(e.title),t(".eaelec-modal-body p").html(e.description),t(".eaelec-modal-footer a").attr("href",e.url)})}});c.onclick=function(){r.style.display="none"}})});
...
!function(r){jQuery(document).ready(function(){function i(e,t){if(null===e||void 0===t)return null;var a=document.querySelector(e),l=Array.prototype.slice.call(a.querySelectorAll(t)),n=0;if(0===l.length)return document.getElementById("eael-toc").classList.add("eael-toc-disable"),null;l.forEach(function(e){e.id=n+"-"+h(e.innerHTML),e.classList.add("eael-heading-content"),n++}),function(e,t){var a=t,l=document.getElementById("eael-toc-list"),n=document.querySelector(e);allHeadings=n.querySelectorAll(a),baseTag=parentLevel=a.trim().split(",")[0].substr(1,1),(ListNode=l).innerHTML="";for(var o=0,s=allHeadings.length;o<s;++o){var i=allHeadings[o],c=parseInt(i.tagName.substr(1,1)),r=c-parentLevel;if(0<r){var d=ListNode.lastChild;if(d){var u=document.createElement("UL");d.appendChild(u),ListNode=u,parentLevel=c}}var _=!1;if(r<0){for(;0!=r++;)ListNode.parentNode.parentNode&&(ListNode=ListNode.parentNode.parentNode);parentLevel=c,_=!0}"UL"!==ListNode.tagName&&(ListNode=l);var m=document.createElement("LI"),g=document.createElement("A"),p=document.createElement("SPAN");baseTag!==parentLevel&&!_||(m.setAttribute("itemscope",""),m.setAttribute("itemtype","http://schema.org/ListItem"),m.setAttribute("itemprop","itemListElement")),Linkid="#"+o+"-"+h(i.textContent),g.className="eael-toc-link",g.setAttribute("itemprop","item"),g.setAttribute("href",Linkid),p.appendChild(document.createTextNode(i.textContent)),g.appendChild(p),m.appendChild(g),ListNode.appendChild(m)}}(e,t),r("ul.eael-toc-list > li").each(function(){this.classList.add("eael-first-child")})}var e=r("#eael-toc").data("eaeltoctag");""!==e&&i(c(),e),r(document).on("click","ul.eael-toc-list li a",function(e){e.preventDefault(),r(document).off("scroll");var t=r(this).parent();if(t.is(".eael-highlight.active"))return t.removeClass("eael-highlight active"),!1;r("ul.eael-toc-list li").removeClass("active"),r(".eael-first-child").removeClass("eael-highlight"),r(this).closest(".eael-first-child").addClass("eael-highlight"),r(this).parent().addClass("active");var a=this.hash;r(a);window.location.hash=a}),window.onscroll=function(){!function(){var e=document.getElementById("eael-toc");if(!e)return;window.pageYOffset>=a?e.classList.add("eael-sticky"):e.classList.remove("eael-sticky")}()};var t=document.getElementById("eael-toc"),a=t?t.offsetTop:0;function h(){return"eael-unique-link"}function c(){var e=null;return r(".elementor-inner")[0]?e=".elementor-inner":r("#site-content")[0]&&(e="#site-content"),e}if(r(document).on("click",".eael-toc-close ,.eael-toc-button",function(){r(".eael-toc").toggleClass("expanded")}),isEditMode){elementor.settings.page.addChangeCallback("eael_ext_table_of_content",function(e){var t,a,l,n,o;if(r("#eael-toc").remove(),"yes"===e){var s=elementor.settings.page.getSettings();r("body").append((t=s.settings,a=t.eael_ext_toc_title,l="eael-toc-list eael-toc-list-"+t.eael_ext_table_of_content_list_style,t.eael_ext_toc_supported_heading_tag.join(", "),n=t.eael_ext_table_of_content_header_icon.value,o="right"===t.eael_ext_toc_position?" eael-toc-right":" ",l+="yes"===t.eael_ext_toc_collapse_sub_heading?" eael-toc-collapse":" ",'<div id="eael-toc" class="eael-toc '+o+'"><div class="eael-toc-header"><span class="eael-toc-close">×</span><h2 class="eael-toc-title">'+a+'</h2></div><div class="eael-toc-body"><ul id="eael-toc-list" class="'+(l+="number"===t.eael_ext_toc_list_icon?" eael-toc-number":" ")+'"></ul></div><button class="eael-toc-button"><i class="'+n+'"></i><span>'+a+"</span></button></div>")),i(c(),s.settings.eael_ext_toc_supported_heading_tag.join(", "))}}),elementor.settings.page.addChangeCallback("eael_ext_toc_position",function(e){"right"===e?r("#eael-toc").addClass("eael-toc-right"):r("#eael-toc").removeClass("eael-toc-right")}),elementor.settings.page.addChangeCallback("eael_ext_table_of_content_list_style",function(e){var t=r(".eael-toc-list");t.removeClass("eael-toc-list-style_2 eael-toc-list-style_3"),"style_1"!==e&&t.addClass("eael-toc-list-"+e)}),elementor.settings.page.addChangeCallback("eael_ext_toc_collapse_sub_heading",function(e){var t=r(".eael-toc-list");"yes"===e?t.addClass("eael-toc-collapse"):t.removeClass("eael-toc-collapse")}),elementor.settings.page.addChangeCallback("eael_ext_table_of_content_header_icon",function(e){r(".eael-toc-button i").removeClass().addClass(e.value)}),elementor.settings.page.addChangeCallback("eael_ext_toc_list_icon",function(e){var t=r(".eael-toc-list");"number"===e?t.addClass("eael-toc-number"):t.removeClass("eael-toc-number")}),elementor.settings.page.addChangeCallback("eael_ext_toc_word_wrap",function(e){var t=r(".eael-toc-list");"yes"===e?t.addClass("eael-toc-word-wrap"):t.removeClass("eael-toc-word-wrap")}),elementor.settings.page.addChangeCallback("eael_ext_toc_title",function(e){elementorFrontend.elements.$document.find(".eael-toc-title").text(e),elementorFrontend.elements.$document.find(".eael-toc-button span").text(e)})}})}(jQuery);
