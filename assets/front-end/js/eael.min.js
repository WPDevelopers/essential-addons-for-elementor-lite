...
var EventCalendar=function(e,l){var a=FullCalendar.Calendar,t=l(".eael-event-calendar-cls",e),o=l(".eaelec-modal-close",e).eq(0),d=l("#eaelecModal",e),m=t.data("events"),n=t.data("first_day"),r=t.data("cal_id");calendarEl=document.getElementById("eael-event-calendar-"+r);var Y=new a(calendarEl,{plugins:["dayGrid","timeGrid","list"],editable:!1,selectable:!1,draggable:!1,firstDay:n,timeFormat:"hh:mm a",nextDayThreshold:"00:00:00",header:{left:"prev,next today",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay,listWeek"},buttonText:{today:"Today"},allDayText:"All day",events:m,selectHelper:!0,eventLimit:3,eventRender:function(e){var a=l(e.el),r=e.event;a.attr("href","javascript:void(0);"),a.click(function(){var e=r.start,a="h:mm A",t=r.end,o=l("span.eaelec-event-date-start"),m=l("span.eaelec-event-date-end");"yes"===r.allDay&&(t=moment(t).subtract(1,"days")._d,a=" ");o.html(" "),m.html(" ");var n=a.trim().length;d.addClass("eael-ec-popup-ready").removeClass("eael-ec-modal-removing"),"yes"===r.allDay&&null===r.end?o.html('<i class="eicon-calendar"></i> '+moment(r.start).format("MMM Do")):(!0===moment(r.start).isSame(Date.now(),"day")&&o.html('<i class="eicon-calendar"></i> Today, '+moment(r.start).format(a)),moment(e).format("MM-DD-YYYY")===moment(new Date).add(1,"days").format("MM-DD-YYYY")&&o.html('<i class="eicon-calendar"></i> Tomorrow, '+moment(r.start).format(a)),(moment(e).format("MM-DD-YYYY")<moment(new Date).format("MM-DD-YYYY")||moment(e).format("MM-DD-YYYY")>moment(new Date).add(1,"days").format("MM-DD-YYYY"))&&o.html('<i class="eicon-calendar"></i> '+moment(r.start).format("MMM Do, "+a)),!0===moment(t).isSame(Date.now(),"day")&&0<n&&m.html("- "+moment(t).format(a)),moment(e).format("MM-DD-YYYY")!==moment(new Date).add(1,"days").format("MM-DD-YYYY")&&moment(t).format("MM-DD-YYYY")===moment(new Date).add(1,"days").format("MM-DD-YYYY")&&m.html("- Tomorrow, "+moment(t).format(a)),moment(e).format("MM-DD-YYYY")===moment(new Date).add(1,"days").format("MM-DD-YYYY")&&moment(r.end).format("MM-DD-YYYY")===moment(new Date).add(1,"days").format("MM-DD-YYYY")&&m.html("- "+moment(t).format(a)),moment(r.end).format("MM-DD-YYYY")>moment(new Date).add(1,"days").format("MM-DD-YYYY")&&m.html("- "+moment(t).format("MMM Do, "+a)),moment(e).format("MM-DD-YYYY")>moment(new Date).add(1,"days").format("MM-DD-YYYY")&&moment(e).format("MM-DD-YYYY")===moment(r.end).format("MM-DD-YYYY")&&m.html("- "+moment(t).format(a))),l(".eaelec-modal-header h2").html(r.title),l(".eaelec-modal-body p").html(r.extendedProps.description),l(".eaelec-modal-footer a").attr("href",r.url),"on"===r.external&&l(".eaelec-modal-footer a").attr("target","_blank"),"on"===r.nofollow&&l(".eaelec-modal-footer a").attr("rel","nofollow"),""==r.url&&l(".eaelec-modal-footer a").css("display","none"),l(".eaelec-modal-header").css("border-left","5px solid "+r.borderColor)})}});o.on("click",function(){d.addClass("eael-ec-modal-removing").removeClass("eael-ec-popup-ready")}),Y.render()};jQuery(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/eael-event-calendar.default",EventCalendar)});
