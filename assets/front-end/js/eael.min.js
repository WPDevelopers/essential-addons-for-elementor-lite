...
var TwitterFeedHandler=function(e,t){$gutter=t(".eael-twitter-feed-masonry",e).data("gutter"),$twitter_feed_gallery=t(".eael-twitter-feed-masonry",e).isotope({itemSelector:".eael-twitter-feed-item",percentPosition:!0,masonry:{columnWidth:".eael-twitter-feed-item",gutter:$gutter}}),$twitter_feed_gallery.imagesLoaded().progress(function(){$twitter_feed_gallery.isotope("layout")})};jQuery(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/eael-twitter-feed.default",TwitterFeedHandler)});