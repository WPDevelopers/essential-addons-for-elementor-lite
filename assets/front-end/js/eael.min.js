...
jQuery(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/eael-event-calendar.default",function(e,t){var a=t(".eael-event-calendar-cls",e),n=a.data("events"),o=a.data("days_week"),m=a.data("month_names"),l=a.data("first_day"),d=document.getElementById("eaelecModal"),r=document.getElementsByClassName("eaelec-modal-close")[0],s=a.data("cal_id");t("#eael-event-calendar-"+s).fullCalendar({editable:!1,selectable:!1,draggable:!1,firstDay:l,slotLabelFormat:"HH:mm",timeFormat:"hh:mm a",nextDayThreshold:"00:00:00",header:{left:"prev,next today",center:"title",right:"month,agendaWeek,agendaDay"},buttonText:{today:"Today"},allDayText:"All day",events:n,selectHelper:!0,dayNamesShort:o,monthNames:m,eventRender:function(e,a){a.attr("href","javascript:void(0);"),a.click(function(){d.style.display="block","yes"==e.allDay?t("span.eaelec-event-date-start").html('<i class="eicon-calendar"></i> '+moment(e.start).format("MMM Do")):(1==moment(e.start).isSame(Date.now(),"day")&&t("span.eaelec-event-date-start").html('<i class="eicon-calendar"></i> Today, '+moment(e.start).format("h:mm A")),moment(e.start).format("MM-DD-YYYY")==moment(new Date).add(1,"days").format("MM-DD-YYYY")&&t("span.eaelec-event-date-start").html('<i class="eicon-calendar"></i> Tomorrow, '+moment(e.start).format("h:mm A")),(moment(e.start).format("MM-DD-YYYY")<moment(new Date).format("MM-DD-YYYY")||moment(e.start).format("MM-DD-YYYY")>moment(new Date).add(1,"days").format("MM-DD-YYYY"))&&t("span.eaelec-event-date-start").html('<i class="eicon-calendar"></i> '+moment(e.start).format("MMM Do, h:mm A")),1==moment(e.end).isSame(Date.now(),"day")&&t("span.eaelec-event-date-end").html("- "+moment(e.end).format("h:mm A")),moment(e.start).format("MM-DD-YYYY")!=moment(new Date).add(1,"days").format("MM-DD-YYYY")&&moment(e.end).format("MM-DD-YYYY")==moment(new Date).add(1,"days").format("MM-DD-YYYY")&&t("span.eaelec-event-date-end").html("- Tomorrow, "+moment(e.end).format("h:mm A")),moment(e.start).format("MM-DD-YYYY")==moment(new Date).add(1,"days").format("MM-DD-YYYY")&&moment(e.end).format("MM-DD-YYYY")==moment(new Date).add(1,"days").format("MM-DD-YYYY")&&t("span.eaelec-event-date-end").html("- "+moment(e.end).format("h:mm A")),moment(e.end).format("MM-DD-YYYY")>moment(new Date).add(1,"days").format("MM-DD-YYYY")&&t("span.eaelec-event-date-end").html("- "+moment(e.end).format("MMM Do, h:mm A")),moment(e.start).format("MM-DD-YYYY")>moment(new Date).add(1,"days").format("MM-DD-YYYY")&&moment(e.start).format("MM-DD-YYYY")==moment(e.end).format("MM-DD-YYYY")&&t("span.eaelec-event-date-end").html("- "+moment(e.end).format("h:mm A"))),t(".eaelec-modal-header h2").html(e.title),t(".eaelec-modal-body p").html(e.description),t(".eaelec-modal-footer a").attr("href",e.url),"on"==e.external&&t(".eaelec-modal-footer a").attr("target","_blank"),"on"==e.nofollow&&t(".eaelec-modal-footer a").attr("rel","nofollow"),""==e.url&&t(".eaelec-modal-footer a").css("display","none"),t(".eaelec-modal-close").css("background-color",e.borderColor),t(".eaelec-modal-header").css("border-left","5px solid "+e.borderColor),t(".eaelec-modal-header span").css("color",e.borderColor)})}}),t("#eael-event-calendar-"+s+" .fc-right .fc-button-group").css("display","none"),t("#eael-event-calendar-"+s+" .fc-right").append('<select id="eaelec-select-mwd-'+s+'" class="eaelec-select-view form-control"><option value="month">Month</option><option value="week">Week</option><option value="day">Day</option></select>'),t("#eaelec-select-mwd-"+s).on("change",function(e){"month"===t(this).val()&&t("#eael-event-calendar-"+s).fullCalendar("changeView","month"),"week"===t(this).val()&&t("#eael-event-calendar-"+s).fullCalendar("changeView","agendaWeek"),"day"===t(this).val()&&t("#eael-event-calendar-"+s).fullCalendar("changeView","agendaDay")}),r.onclick=function(){d.style.display="none"}})});
...
var filterableGalleryHandler=function(f,s){var i,a,t,e=f.find(".fg-layout-3-filter-controls").eq(0),l=f.find("#fg-filter-trigger"),o=f.find(".fg-layout-3-search-box"),n=f.find("#fg-search-box-input"),r="";if(o.length&&o.on("submit",function(e){e.preventDefault()}),l.on("click",function(){e.toggleClass("open-filters")}).blur(function(){e.toggleClass("open-filters")}),!isEditMode){var g=s(".eael-filter-gallery-container",f),c=g.data("settings"),d=g.data("gallery-items"),u="masonry"==c.grid_style?"masonry":"fitRows",m="yes"==c.gallery_enabled,p=s(".eael-filter-gallery-wrapper").data("layout-mode"),y=g.isotope({itemSelector:".eael-filterable-gallery-item-wrap",layoutMode:u,percentPosition:!0,stagger:30,transitionDuration:c.duration+"ms",filter:function(){var e=s(this),t=!i||e.text().match(i);null==a&&(a="layout_3"!=p?f.find(".eael-filter-gallery-control ul li").first().data("filter"):f.find(".fg-layout-3-filter-controls li").first().data("filter"));var l=!a||e.is(a);return t&&l}});s(".eael-magnific-link",f).magnificPopup({type:"image",gallery:{enabled:m},callbacks:{close:function(){s("#elementor-lightbox").hide()}}}),f.on("click",".control",function(){var e=s(this);a=s(this).attr("data-filter"),r=s(this).attr("data-filter")+" a.eael-magnific-link",f.find("#fg-filter-trigger > span")&&f.find("#fg-filter-trigger > span").text(e.text()),e.siblings().removeClass("active"),e.addClass("active"),s(r).magnificPopup({type:"image",gallery:{enabled:m},callbacks:{close:function(){s("#elementor-lightbox").hide()}}}),y.isotope()}),n.on("input",function(){var e=s(this);clearTimeout(t),t=setTimeout(function(){i=new RegExp(e.val(),"gi"),y.isotope()},600)}),y.imagesLoaded().progress(function(){y.isotope("layout")}),y.on("arrangeComplete",function(){y.isotope("layout")}),s(window).on("load",function(){y.isotope("layout")}),s(f).magnificPopup({delegate:".eael-magnific-video-link",type:"iframe",callbacks:{close:function(){s("#elementor-lightbox").hide()}}}),f.on("click",".eael-gallery-load-more",function(e){e.preventDefault();var t=s(this),l=s(".eael-filter-gallery-container",f).children(".eael-filterable-gallery-item-wrap").length,i=g.data("total-gallery-items"),a=g.data("images-per-page"),o=g.data("nomore-item-text"),n=[];l==i&&(t.html('<div class="no-more-items-text">'+o+"</div>"),setTimeout(function(){t.fadeOut("slow")},600));for(var r=l;r<l+a;r++)n.push(s(d[r])[0]);g.append(n),y.isotope("appended",n),y.imagesLoaded().progress(function(){y.isotope("layout")}),s(".eael-magnific-link",f).magnificPopup({type:"image",gallery:{enabled:m},callbacks:{close:function(){s("#elementor-lightbox").hide()}}})})}};jQuery(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/eael-filterable-gallery.default",filterableGalleryHandler)});
