...
!function(i){"use strict";window.eaelLoadMore=function(){i(".eael-load-more-button").on("click",function(a){a.preventDefault();var e=i(this),o=e.data("widget"),t=e.data("class"),d=e.data("args"),n=e.data("settings"),l=e.data("layout"),s=e.data("page");e.addClass("button--loading"),i("span",e).html("Loading..."),i.ajax({url:localize.ajaxurl,type:"post",data:{action:"load_more",widget_id:o,class:t,args:d,settings:n,layout:l,page:s},success:function(a){var e=i(a);"masonry"==l?(console.log("cool!"),console.log(o),console.log(i(".eael-post-appender-".$widget_id)),i(".eael-post-appender-".$widget_id).isotope(),i(".eael-post-appender-".$widget_id).append(e).isotope("appended",e)):(console.log("hot!"),i(".eael-post-appender-".$widget_id).append(e))},error:function(a){console.log(a)}})})}}(jQuery);
...
var PostGrid=function(e,o){var t=o(".eael-post-grid",e).isotope({itemSelector:".eael-grid-post",percentPosition:!0,columnWidth:".eael-post-grid-column"});t.imagesLoaded().progress(function(){t.isotope("layout")}),eaelLoadMore()};jQuery(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/eael-post-grid.default",PostGrid)});
