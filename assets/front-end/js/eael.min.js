...
!function(f){"use strict";f(document).on("click",".eael-load-more-button",function(a){a.preventDefault(),a.stopPropagation(),a.stopImmediatePropagation();var e=f(this),n=f("span",e).html(),t=e.data("widget"),s=f(".elementor-element-"+t),o=e.data("class"),i=e.data("args"),r=e.data("settings"),l=e.data("layout"),p=parseInt(e.data("page"))+1;if(void 0!==t&&void 0!==i){var d={},g={action:"load_more",class:o,args:i,settings:r,page:p};if(String(i).split("&").forEach(function(a,t){var o=String(a).split("=");d[o[0]]=o[1]}),"rand"==d.orderby){var u=f(".eael-grid-post");if(u.length){var c=[];u.each(function(a,t){var o=f(t).data("id");console.log(o),c.push(o)}),g.post__not_in=c}}e.addClass("button--loading"),f("span",e).html("Loading..."),f.ajax({url:localize.ajaxurl,type:"post",data:g,success:function(a){var t=f(a);if(t.hasClass("no-posts-found")||0==t.length)e.remove();else{if(f(".eael-post-appender",s).append(t),"masonry"==l){var o=f(".eael-post-appender",s).isotope();o.isotope("appended",t).isotope("layout"),o.imagesLoaded().progress(function(){o.isotope("layout")})}e.removeClass("button--loading"),f("span",e).html(n),e.data("page",p)}},error:function(a){console.log(a)}})}})}(jQuery);
