...
!function(s){jQuery(document).ready(function(){function a(e,t){var a=document.querySelector(e),l=Array.prototype.slice.call(a.querySelectorAll(t)),o=0;l.forEach(function(e){e.id=o+"-"+p(e.innerHTML),e.classList.add("eael-heading-content"),o++}),function(e,t){var a=t,l=document.getElementById("eael-toc-list"),o=document.querySelector(e);l.innerHTML="",allHeadings=o.querySelectorAll(a),baseTag=parentLevel=a.trim().split(",")[0].substr(1,1),ListNode=l;for(var i=0,s=allHeadings.length;i<s;++i){var n=allHeadings[i],c=parseInt(n.tagName.substr(1,1)),r=c-parentLevel;if(0<r){var d=ListNode.lastChild;if(d){var g=document.createElement("UL");d.appendChild(g),ListNode=g,parentLevel=c}}var u=!1;if(r<0){for(;0!=r++;)ListNode.parentNode.parentNode&&(ListNode=ListNode.parentNode.parentNode);parentLevel=c,u=!0}"UL"!==ListNode.tagName&&(ListNode=l);var m=document.createElement("LI"),h=document.createElement("A");baseTag!==parentLevel&&!u||(m.className="eael-first-child",m.setAttribute("itemscope",""),m.setAttribute("itemtype","http://schema.org/ListItem"),m.setAttribute("itemprop","itemListElement")),Linkid="#"+i+"-"+p(n.textContent),h.className="eael-toc-link",h.setAttribute("itemprop","item"),h.setAttribute("href",Linkid),h.appendChild(document.createTextNode(n.textContent)),m.appendChild(h),ListNode.appendChild(m)}}(e,t)}var e=s("#eael-toc").data("eaeltoctag");""!==e&&a(".elementor-widget-wrap",e),s(document).on("click","ul.eael-toc-list li a",function(e){e.preventDefault(),s(document).off("scroll");var t=s(this).parent();if(t.is(".eael-highlight.active"))return t.removeClass("eael-highlight active"),!1;s("ul.eael-toc-list li").removeClass("active"),s(".eael-first-child").removeClass("eael-highlight"),s(this).closest(".eael-first-child").addClass("eael-highlight"),s(this).parent().addClass("active");var a=this.hash;s(a);window.location.hash=a}),s(document).on("scroll",function(e){var a=s(document).scrollTop();t.each(function(){var e=s(this),t=s(e.attr("href"));t.position().top<=a&&t.position().top+t.height()>a&&(s("ul.eael-toc-list li").removeClass("active"),s(".eael-first-child").removeClass("eael-highlight"),e.closest(".eael-first-child").addClass("eael-highlight"),e.parent().addClass("active"))})});var t=s("ul.eael-toc-list li a");window.onscroll=function(){!function(){if(!l)return;window.pageYOffset>=o?l.classList.add("eael-sticky"):l.classList.remove("eael-sticky")}()};var l=document.getElementById("eael-toc"),o=l?l.offsetTop:0;function p(){return"eael-uniq-link"}if(s(".eael-toc-close ,.eael-toc-button").click(function(e){s(".eael-toc").toggleClass("expanded")}),isEditMode){function i(e){elementorFrontend.elements.$document.find(".eael-toc-title").text(e),elementorFrontend.elements.$document.find(".eael-toc-button span").text(e)}elementor.settings.page.addChangeCallback("eael_ext_table_of_content",function(e){if("yes"!==e)s("#eael-toc").addClass("eael-toc-disable");else{var t=elementor.settings.page.getSettings();i(t.settings.eael_ext_toc_title),a(".elementor-widget-wrap",t.settings.eael_ext_toc_supported_heading_tag.join(", ")),s("#eael-toc").removeClass("eael-toc-disable eael-toc-global")}}),elementor.settings.page.addChangeCallback("eael_ext_toc_position",function(e){"right"===e?s("#eael-toc").addClass("eael-toc-right"):s("#eael-toc").removeClass("eael-toc-right")}),elementor.settings.page.addChangeCallback("eael_ext_table_of_content_list_style",function(e){var t=s(".eael-toc-list");t.removeClass("eael-toc-list-style_2 eael-toc-list-style_3"),"style_1"!==e&&t.addClass("eael-toc-list-"+e)}),elementor.settings.page.addChangeCallback("eael_ext_toc_collapse_sub_heading",function(e){var t=s(".eael-toc-list");"yes"===e?t.addClass("eael-toc-collapse"):t.removeClass("eael-toc-collapse")}),elementor.settings.page.addChangeCallback("eael_ext_table_of_content_header_icon",function(e){s(".eael-toc-button i").removeClass().addClass(e.value)}),elementor.settings.page.addChangeCallback("eael_ext_toc_list_icon",function(e){var t=s(".eael-toc-list");"number"===e?t.addClass("eael-toc-number"):t.removeClass("eael-toc-number")}),elementor.settings.page.addChangeCallback("eael_ext_toc_title",i)}})}(jQuery);
