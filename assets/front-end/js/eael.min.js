...
$(document).ready(function(){alert("Hello there");var r=$("#calendar").fullCalendar({editable:!0,header:{left:"prev,next today",center:"title",right:"month,agendaWeek,agendaDay"},events:"load.php",selectable:!0,selectHelper:!0,select:function(e,t,a){var l=prompt("Enter Event Title");if(l){e=$.fullCalendar.formatDate(e,"Y-MM-DD HH:mm:ss"),t=$.fullCalendar.formatDate(t,"Y-MM-DD HH:mm:ss");$.ajax({url:"insert.php",type:"POST",data:{title:l,start:e,end:t},success:function(){r.fullCalendar("refetchEvents"),alert("Added Successfully")}})}},editable:!0})});
