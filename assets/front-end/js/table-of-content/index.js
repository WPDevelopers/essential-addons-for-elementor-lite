    ...
    jQuery(document).ready(function () {
        ...
        function eael_toc_content(selector, supportTag) {
            ...
            var mainSelector = document.querySelector(selector),
                allSupportTag = Array.prototype.slice.call(
                    mainSelector.querySelectorAll(supportTag)
                ),
                listIndex = 0
            ...
            if (firstChild.length < 1) {
                document
                    ...
                    .classList.add('eael-toc-disable')
            }
        ...
        if (isEditMode) {
            ...
            elementor.settings.page.addChangeCallback(
                ...
                function (newValue) {
                    ...
                    if (newValue === 'yes') {
                        ...
                        eael_toc_content(
                            eael_toc_check_content(),
                            $settings.settings.eael_ext_toc_supported_heading_tag.join(
                                ', '
                            )
                        )
                    } else {
            ...
            elementor.settings.page.addChangeCallback(
                ...
                function (newValue) {
                    var list = $('.eael-toc-list')
                    if (newValue === 'number') {
                        list.addClass('eael-toc-number').removeClass(
                            'eael-toc-bullet'
                        )
                    } else {
                        list.addClass('eael-toc-bullet').removeClass(
                            'eael-toc-number'
                        )
                    }
                }
