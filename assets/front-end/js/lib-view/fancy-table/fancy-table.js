    ...
    $.fn.fancyTable = function(options) {
        ...
        this.tableUpdate = function (elm) {
            ...
            if(settings.pagination){
                var paginationElement = (elm.fancyTable.paginationElement) ? $(elm.fancyTable.paginationElement) : $(elm).find(".eael-event-calendar-pagination");
        ...
        this.each(function() {
            ...
            if(settings.pagination && !settings.paginationElement){
                ...
                $(elm).find("tfoot tr").append($("<td class='eael-event-calendar-pagination'></td>",{ }).attr("colspan",elm.fancyTable.nColumns));
            }
            instance.tableUpdate(elm);
