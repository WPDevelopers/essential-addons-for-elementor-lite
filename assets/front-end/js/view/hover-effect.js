...
eval("var HoverEffectHandler = function HoverEffectHandler($scope, $) {\n  var $data_options = $scope.data('rotate_effect'),\n    $eaelContainer = $('.elementor-widget-container', $scope),\n    $rotateX = $data_options.rotate_x ? \"rotateX(\".concat($data_options.rotate_x, \"deg)\") : '',\n    $rotateY = $data_options.rotate_y ? \"rotateY(\".concat($data_options.rotate_y, \"deg)\") : '',\n    $rotateZ = $data_options.rotate_z ? \"rotateZ(\".concat($data_options.rotate_z, \"deg)\") : '';\n  $eaelContainer.css({\n    \"transform\": \"\".concat($rotateX, \" \").concat($rotateY, \" \").concat($rotateZ)\n  });\n};\njQuery(window).on(\"elementor/frontend/init\", function () {\n  if (ea.elementStatusCheck('eaelHoverEffect')) {\n    return false;\n  }\n  elementorFrontend.hooks.addAction(\"frontend/element_ready/widget\", HoverEffectHandler);\n});\n\n//# sourceURL=webpack:///./src/js/view/hover-effect.js?");
