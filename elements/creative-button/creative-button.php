...
<?php elseif ( $settings['creative_button_effect'] == 'eael-creative-button--pipaluk' ): ?>

    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--pipaluk::after {
        background-color: <?php echo esc_attr($settings['eael_creative_button_background_color'] ); ?>;
    }    

<?php elseif ( $settings['creative_button_effect'] == 'eael-creative-button--wave' ): ?>

    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--wave:hover {
        background-color: <?php echo esc_attr($settings['eael_creative_button_background_color'] ); ?>;
    }
    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--wave::before, 
    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--wave:hover::before {
        background-color: <?php echo esc_attr($settings['eael_creative_button_hover_background_color'] ); ?>;
    }
    

<?php elseif ( $settings['creative_button_effect'] == 'eael-creative-button--aylen' ): ?>

    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--aylen::before {
        background-color: <?php echo esc_attr($settings['eael_creative_button_background_color'] ); ?>;
    }

    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--aylen::after {
        background-color: <?php echo esc_attr($settings['eael_creative_button_hover_background_color'] ); ?>;
    }   

<?php elseif ( $settings['creative_button_effect'] == 'eael-creative-button--saqui' ): ?>

    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--saqui:hover {
        color: <?php echo esc_attr($settings['eael_creative_button_hover_background_color'] ); ?>;
    }
    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--saqui::after {
        color: <?php echo esc_attr($settings['eael_creative_button_hover_text_color'] ); ?>;
        padding: <?php echo $button_padding['top'] . $button_padding['unit'] .' '.  $button_padding['right'] . $button_padding['unit'] .' '.  $button_padding['bottom'] . $button_padding['unit'] .' '.  $button_padding['left'] . $button_padding['unit'] ?>;
    }


<?php elseif ( $settings['creative_button_effect'] == 'eael-creative-button--nuka' ): ?>
    
    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--nuka::before, 
    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--nuka::after {
        background-color: <?php echo esc_attr($settings['eael_creative_button_background_color'] ); ?>;
    }

    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--nuka:hover::after {
        background-color: <?php echo esc_attr($settings['eael_creative_button_hover_background_color'] ); ?>;
    }


<?php elseif ( $settings['creative_button_effect'] == 'eael-creative-button--antiman' ): ?>

    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--antiman::after {
        background-color: <?php echo esc_attr($settings['eael_creative_button_background_color'] ); ?>;
    }
    

<?php elseif ( $settings['creative_button_effect'] == 'eael-creative-button--quidel' ): ?>

    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--quidel::after {
        background-color: <?php echo esc_attr($settings['eael_creative_button_background_color'] ); ?>;
    }
    a#eael-creative-button-<?php echo esc_attr($this->get_id()); ?>.eael-creative-button--quidel:hover::after {
        background-color: <?php echo esc_attr($settings['eael_creative_button_hover_background_color'] ); ?>;
    }
