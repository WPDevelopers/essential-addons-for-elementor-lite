   ...
   public function get_categories() {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Pricing Table Styles', 'essential-addons-elementor' ),
		...
		$this->add_control(
			'eael_pricing_table_border_type',
			[
				...
				'selectors' => [
	 					'{{WRAPPER}} .eael-pricing .eael-pricing-item' => 'border-style: {{VALUE}};',
	 			],
			]
		);

		$this->add_control(
			'eael_pricing_table_border_thickness',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-pricing .eael-pricing-item' => 'border-width: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			'eael_pricing_table_border_color',
			[
				...
				'separator' => 'after',
				'selectors' => [
					'{{WRAPPER}} .eael-pricing .eael-pricing-item' => 'border-color: {{VALUE}};',
				],
			]
		...
		/**
		 * -------------------------------------------
		 * Tab Style (Pricing Table Price Tag Style)
		 * -------------------------------------------
		 */
		$this->start_controls_section(
			'eael_section_pricing_table_price_tag_style_settings',
			[
				'label' => esc_html__( 'Price Tag Typography &amp; Color', 'essential-addons-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		/**
		 * -------------------------------------------
		 * Tab Style (Pticing Table List Item Style)
		 * -------------------------------------------
		 */
		$this->start_controls_section(
			'eael_section_pricing_table_price_list_item_settings',
			[
				'label' => esc_html__( 'Pricing List Typography &amp; Color', 'essential-addons-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Featured Tag Settings', 'essential-addons-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'eael_pricing_table_style' => [ 'style-3' ]
				]
		...
		$this->start_controls_tabs( 'eael_cta_button_tabs' );
			...
			$this->add_control(
				'eael_pricing_table_btn_border_type',
				[
					'label' => esc_html__( 'Border Type', 'essential-addons-elementor' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'none',
					...
					'selectors' => [
		 					'{{WRAPPER}} .eael-pricing .eael-pricing-button' => 'border-style: {{VALUE}};',
		 			],
				]
			);

			$this->add_control(
				'eael_pricing_table_btn_border_thickness',
				[
					'label' => esc_html__( 'Border Size', 'essential-addons-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
					...
					'selectors' => [
						'{{WRAPPER}} .eael-pricing .eael-pricing-button' => 'border-width: {{SIZE}}px;',
					],
				]
			);
			...
			$this->add_control(
				'eael_pricing_table_btn_normal_border_color',
				[
					'label' => esc_html__( 'Border Color', 'essential-addons-elementor' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .eael-pricing .eael-pricing-button' => 'border-color: {{VALUE}};',
					],
				]
