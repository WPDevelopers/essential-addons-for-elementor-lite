	...
	protected function render( ) {
		...
		$this->add_render_attribute(
			...
			[
				...
				'data-categories'		=> json_encode( is_array( $post_categories ) ? $post_categories : [] ),
				'data-tags'				=> json_encode( is_array( $post_tags ) ? $post_tags : [] ),
				'data-exclude_posts'	=> json_encode( is_array( $exclude_posts ) ? $exclude_posts : [] ),
			]
		);
