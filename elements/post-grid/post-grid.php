...
(function($) {
	...
	var showMeta 		= <?php echo $settings['eael_show_meta']; ?>;
	var metaPosition 	= '<?php echo $settings['eael_post_grid_meta_position']; ?>';
	var excerptLength 	= parseInt( <?php echo $settings['eael_excerpt_length']; ?>, 10 );
	var btnText			= '<?php echo $settings['eael_post_grid_show_load_more_text']; ?>';
