...
class Eael_Filterable_Gallery extends Widget_Base {
			...
			[
				...
				'fields' => [
					...
					[
						...
						'default' => [
							'url' => EAEL_PLUGIN_URL . 'front-end/assets/img/flexia-preview.jpg',
						],
					],
					[
						...
						'type'		=> Controls_Manager::MEDIA,
						'default' => [
							'url' => EAEL_PLUGIN_URL . 'front-end/assets/img/play-icon.png',
						],
						'condition'	=> [
							'fg_video_gallery_switch'	=> 'true'
						]
