...
$config = [
    'elements' => [
        ...
        'sticky-video' => [
            ...
            'dependency' => [
                'css' => [
                    EAEL_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'assets/front-end/css/vendor/sticky-video/sticky-video-ckin.min.css',
                    EAEL_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'assets/front-end/css/sticky-video/index.min.css',
                ],
                'js' => [
                    EAEL_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'assets/front-end/js/vendor/sticky-video/sticky-video-ckin.min.js',
